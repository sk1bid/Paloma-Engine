...
class VoxelArray : public NS::Referencing<Object> {
  ...
  class VoxelArray *init(const MDL::Asset *asset, int divisions,
                         float patchRadius);
  ...
  class VoxelArray *init(const MDL::Asset *asset, int divisions,
                         int interiorShells, int exteriorShells,
                         float patchRadius);
  ...
  BOOL voxelExistsAtIndex(VoxelIndex index, BOOL allowAnyX, BOOL allowAnyY,
                          BOOL allowAnyZ, BOOL allowAnyShell);
  ...
  void setVoxelsForMesh(const Mesh *mesh, int divisions, int interiorShells,
                        int exteriorShells, float patchRadius);

  // setVoxelsForMesh:divisions:interiorNBWidth:exteriorNBWidth:patchRadius:
  void setVoxelsForMesh(const Mesh *mesh, int divisions, float interiorNBWidth,
                        float exteriorNBWidth, float patchRadius);
  ...
  class Mesh *
  coarseMeshUsingAllocator(const class MeshBufferAllocator *allocator);
...
_MDL_INLINE MDL::VoxelArray *MDL::VoxelArray::init(const MDL::Asset *asset,
                                                   int divisions,
                                                   float patchRadius) {
  return Object::sendMessage<MDL::VoxelArray *>(
      this, _MDL_PRIVATE_SEL(initWithAsset_divisions_patchRadius_), asset,
      divisions, patchRadius);
}

// method: initWithData:boundingBox:voxelExtent:
_MDL_INLINE MDL::VoxelArray *
MDL::VoxelArray::init(const NS::Data *voxelData,
                      MDL::AxisAlignedBoundingBox boundingBox,
                      float voxelExtent) {
  return Object::sendMessage<MDL::VoxelArray *>(
      this, _MDL_PRIVATE_SEL(initWithData_boundingBox_voxelExtent_), voxelData,
      boundingBox, voxelExtent);
}
...
_MDL_INLINE MDL::VoxelIndexExtent MDL::VoxelArray::voxelIndexExtent() const {
  return Object::sendMessage<VoxelIndexExtent>(
      this, _MDL_PRIVATE_SEL(voxelIndexExtent));
}
...
_MDL_INLINE BOOL MDL::VoxelArray::voxelExistsAtIndex(VoxelIndex index,
  ...
  return Object::sendMessage<BOOL>(
      ...
      index, allowAnyX, allowAnyY, allowAnyZ, allowAnyShell);
}

// method: voxelsWithinExtent:
_MDL_INLINE NS::Data *
MDL::VoxelArray::voxelsWithinExtent(VoxelIndexExtent extent) {
  return Object::sendMessage<NS::Data *>(
      this, _MDL_PRIVATE_SEL(voxelsWithinExtent_), extent);
}
...
_MDL_INLINE void MDL::VoxelArray::setVoxelAtIndex(VoxelIndex index) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setVoxelAtIndex_),
                                   index);
}
...
_MDL_INLINE void MDL::VoxelArray::setVoxelsForMesh(const Mesh *mesh,
  ...
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setVoxelsForMesh_divisions_patchRadius_), index);
}
...
_MDL_INLINE void MDL::VoxelArray::unionWithVoxels(const VoxelArray *voxels) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(unionWithVoxels_),
                                   voxels);
}

// method: intersectWithVoxels:
_MDL_INLINE void
MDL::VoxelArray::intersectWithVoxels(const VoxelArray *voxels) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(intersectWithVoxels_),
                                   voxels);
}

// method: differenceWithVoxels:
_MDL_INLINE void
MDL::VoxelArray::differenceWithVoxels(const VoxelArray *voxels) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(differenceWithVoxels_), voxels);
}
...
_MDL_INLINE MDL::VoxelIndex
MDL::VoxelArray::indexOfSpatialLocation(vector_float3 location) {
  return Object::sendMessage<VoxelIndex>(
      this, _MDL_PRIVATE_SEL(indexOfSpatialLocation_), location);
}

// method: spatialLocationOfIndex:
_MDL_INLINE vector_float3
MDL::VoxelArray::spatialLocationOfIndex(VoxelIndex index) {
  return Object::sendMessage<vector_float3>(
      this, _MDL_PRIVATE_SEL(spatialLocationOfIndex_), index);
}

// method: voxelBoundingBoxAtIndex:
_MDL_INLINE MDL::AxisAlignedBoundingBox
MDL::VoxelArray::voxelBoundingBoxAtIndex(VoxelIndex index) {
  return Object::sendMessage<AxisAlignedBoundingBox>(
      this, _MDL_PRIVATE_SEL(voxelBoundingBoxAtIndex_), index);
}

// method: convertToSignedShellField:
_MDL_INLINE void MDL::VoxelArray::convertToSignedShellField() {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(convertToSignedShellField_));
}
...
_MDL_INLINE BOOL MDL::VoxelArray::isValidSignedShellField() const {
  return Object::sendMessage<BOOL>(this,
                                   _MDL_PRIVATE_SEL(isValidSignedShellField));
}
...
_MDL_INLINE float MDL::VoxelArray::shellFieldInteriorThickness() const {
  return Object::sendMessage<float>(
      this, _MDL_PRIVATE_SEL(shellFieldInteriorThickness));
}
// write method: setShellFieldInteriorThickness:
_MDL_INLINE void MDL::VoxelArray::setShellFieldInteriorThickness(
    float shellFieldInteriorThickness) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setShellFieldInteriorThickness_),
...
_MDL_INLINE float MDL::VoxelArray::shellFieldExteriorThickness() const {
  return Object::sendMessage<float>(
      this, _MDL_PRIVATE_SEL(shellFieldExteriorThickness));
}
// write method: setShellFieldExteriorThickness:
_MDL_INLINE void MDL::VoxelArray::setShellFieldExteriorThickness(
    float shellFieldExteriorThickness) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setShellFieldExteriorThickness_),
...
_MDL_INLINE MDL::Mesh *MDL::VoxelArray::coarseMeshUsingAllocator(
    const class MeshBufferAllocator *allocator) {
  return Object::sendMessage<MDL::Mesh *>(
      this, _MDL_PRIVATE_SEL(coarseMeshUsingAllocator_), allocator);
}

// method: meshUsingAllocator:
_MDL_INLINE MDL::Mesh *MDL::VoxelArray::meshUsingAllocator(
    const class MeshBufferAllocator *allocator) {
  return Object::sendMessage<MDL::Mesh *>(
      this, _MDL_PRIVATE_SEL(meshUsingAllocator_), allocator);
}
...
/**
 ...
 orginal mesh. Choose a patch radius that will be large enough to fill in the
 largest hole in the model.
 */
//- (instancetype)initWithAsset:(MDLAsset*)asset divisions:(int)divisions
//patchRadius:(float)patchRadius;

/**
 Initialize a voxel grid from an NSData containing an array of MDLVoxelIndex
 values.

 @param boundingBox The bounds defining the extent of the volume model in
 Cartesian space
...
/**
 ...
 @param patchRadius The radius of the largest model mending patch in world space
 units
 */
...
//                  patchRadius:(float)patchRadius NS_DEPRECATED(10_11, 10_12,
//                  NA, NA);
...
/**
 ...
 @discussion the allowAny parameters can be used to wildcard any dimensions.
 This is useful to perform queries such as determining if any voxel exists on
 the XY plane at a certain Z, or if any voxel exists at any X, Y, Z, or a
 particular shell, and so on.
 */
//- (BOOL)voxelExistsAtIndex:(MDLVoxelIndex)index
//                 allowAnyX:(BOOL)allowAnyX allowAnyY:(BOOL)allowAnyY
//                 allowAnyZ:(BOOL)allowAnyZ
 ...
 */
//- (void)setVoxelsForMesh:(nonnull MDLMesh*)mesh divisions:(int)divisions
//patchRadius:(float)patchRadius;
...
//          interiorShells:(int)interiorShells
//          exteriorShells:(int)exteriorShells
//             patchRadius:(float)patchRadius NS_DEPRECATED(10_11, 10_12, NA,
//             NA);
...
/**
 ...
 It is assumed that the spatial voxel extent of one voxel in the supplied grid
 is the same as that of the voxel grid. Note that the shell level data will be
 cleared.
 */
//- (void)unionWithVoxels:(MDLVoxelArray*)voxels;

/**
 Intersection modifies the voxel grid so that only voxels that are also in the
 supplied voxel grid are retained. It is assumed that the spatial voxel extent
 of one voxel in the supplied grid is the same as that of the voxel grid. Note
 that the shell level data will be cleared.
 */
...
/**
 ...
 grid are removed. It is assumed that the spatial voxel extent of one voxel in
 the supplied grid is the same as that of the voxel grid. Note that the shell
 level data will be cleared.
 */
...
/**
 Converts volume grid into a signed shell field by surrounding the surface
 voxels, which have shell level values of zero, by an inner layer of voxels with
 shell level values of negative one and an outer layer of voxels with shell
 level values of positive one.
...
/**
 ...
 This property will be set to YES after calling generateSignedShellField. All
 other methods that modify the voxel grid will cause this property to be set to
 NO. Setting shellFieldInteriorThickness and shellFieldExteriorThickness will
 not affect the value of this property.
 */
//@property (nonatomic, readonly) BOOL isValidSignedShellField;

/**
 If voxel grid is in a valid signed shell field form, sets the interior
 thickness to the desired width, as measured from the model surface. If the
 voxel grid is not in a valid signed shell field form, the value of this
 property is zero.
 */
//@property (nonatomic) float shellFieldInteriorThickness;

/**
 If voxel grid is in a valid signed shell field form, sets the exterior
 thickness to the desired width, as measured from the model surface. If the
 voxel grid is not in a valid signed shell field form, the value of this
 property is zero.
 */
...
//- (nullable MDLMesh*)coarseMeshUsingAllocator:(nullable
//id<MDLMeshBufferAllocator>)allocator;

/**
 Creates a smooth mesh from the voxel grid
 */
//- (nullable MDLMesh*)meshUsingAllocator:(nullable
//id<MDLMeshBufferAllocator>)allocator;
//
//
//@end
