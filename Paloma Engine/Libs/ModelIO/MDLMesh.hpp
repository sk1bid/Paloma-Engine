...
public:
  ...
  class Mesh *init(class MeshBuffer *vertexBuffer, NS::UInteger vertexCount,
                   const VertexDescriptor *descriptor,
                   const NS::Array *submeshes);

  // initWithVertexBuffers:vertexCount:descriptor:submeshes:
  class Mesh *init(const NS::Array *vertexBuffers, NS::UInteger vertexCount,
                   const VertexDescriptor *descriptor,
                   const NS::Array *submeshes);

  // vertexAttributeDataForAttributeNamed:
  VertexAttributeData *
  vertexAttributeDataForAttributeNamed(const NS::String *name);
  ...
  void setSubmeshes(const NS::Array *submeshes);
  ...
  void addAttributeWithName(const NS::String *name, VertexFormat format);

  // addAttributeWithName:format:type:data:stride:
  void addAttributeWithName(const NS::String *name, VertexFormat format,
                            const NS::String *type, const NS::Data *data,
                            NS::Integer stride);

  // addAttributeWithName:format:type:data:stride:time:
  void addAttributeWithName(const NS::String *name, VertexFormat format,
                            const NS::String *type, const NS::Data *data,
                            NS::Integer stride, NS::TimeInterval time);
  ...
  void addTangentBasisForTextureCoordinateAttributeNamed1(
      const NS::String *textureCoordinateAttributeName,
  ...
  void addTangentBasisForTextureCoordinateAttributeNamed2(
      const NS::String *textureCoordinateAttributeName,
  ...
  class Mesh *initBoxWithExtent(vector_float3 extent, vector_uint3 segments,
                                BOOL inwardNormals, GeometryType geometryType,
                                class MeshBufferAllocator *allocator);

  // initSphereWithExtent:segments:inwardNormals:geometryType:allocator:
  class Mesh *initSphereWithExtent(vector_float3 extent, vector_uint2 segments,
                                   BOOL inwardNormals,
  ...
  class Mesh *initCylinderWithExtent(vector_float3 extent,
                                     vector_uint2 segments, BOOL inwardNormals,
                                     BOOL topCap, BOOL bottomCap,
                                     GeometryType geometryType,
                                     class MeshBufferAllocator *allocator);

  // initCapsuleWithExtent:cylinderSegments:hemisphereSegments:inwardNormals:geometryType:allocator:
  class Mesh *initCapsuleWithExtent(vector_float3 extent, vector_uint2 segments,
                                    int hemisphereSegments, BOOL inwardNormals,
                                    GeometryType geometryType,
                                    class MeshBufferAllocator *allocator);

  // initConeWithExtent:segments:inwardNormals:geometryType:allocator:
  class Mesh *initConeWithExtent(vector_float3 extent, vector_uint2 segments,
                                 BOOL inwardNormals, BOOL cap,
                                 GeometryType geometryType,
                                 class MeshBufferAllocator *allocator);

  // initPlaneWithExtent:segments:geometryType:allocator:
  class Mesh *initPlaneWithExtent(vector_float3 extent, vector_uint2 segments,
                                  GeometryType geometryType,
                                  class MeshBufferAllocator *allocator);
  ...
  class Mesh *initMeshBySubdividingMesh(const Mesh *mesh, int submeshIndex,
  ...
  static class Mesh *
  newEllipsoidWithRadii(vector_float3 radii, NS::UInteger radialSegments,
                        NS::UInteger verticalSegments,
                        GeometryType geometryType, BOOL inwardNormals,
                        BOOL hemisphere, class MeshBufferAllocator *allocator);

  // newCylinderWithHeight:radii:radialSegments:verticalSegments:geometryType:inwardNormals:allocator:
  static class Mesh *newCylinderWithHeight(
      float height, vector_float2 radii, NS::UInteger radialSegments,
      NS::UInteger verticalSegments, GeometryType geometryType,
      BOOL inwardNormals, class MeshBufferAllocator *allocator);

  // newCapsuleWithHeight:radii:radialSegments:verticalSegments:hemisphereSegments:geometryType:inwardNormals:allocator:
  static class Mesh *newCapsuleWithHeight(float height, vector_float2 radii,
  ...
  static class Mesh *newEllipticalConeWithHeight(
      float height, vector_float2 radii, NS::UInteger radialSegments,
      NS::UInteger verticalSegments, GeometryType geometryType,
      BOOL inwardNormals, class MeshBufferAllocator *allocator);
  ...
  static class Mesh *
  newPlaneWithDimensions(vector_float2 dimensions, vector_uint2 segments,
                         GeometryType geometryType,
                         class MeshBufferAllocator *allocator);

  // newIcosahedronWithRadius:inwardNormals:geometryType:allocator:
  static class Mesh *
  newIcosahedronWithRadius(float radius, BOOL inwardNormals,
                           GeometryType geometryType,
                           class MeshBufferAllocator *allocator);
  ...
  BOOL generateAmbientOcclusionTextureWithSize(
      vector_int2 textureSize, NS::UInteger raysPerSample,
      float attenuationFactor, const NS::Array *objectsToConsider,
  ...
  BOOL generateAmbientOcclusionTextureWithQuality(
      float bakeQuality, float attenuationFactor,
      const NS::Array *objectsToConsider, const NS::String *vertexAttributeName,
      const NS::String *materialPropertyName);

  // generateAmbientOcclusionVertexColorsWithRaysPerSample:attenuationFactor:objectsToConsider:vertexAttributeNamed:
  BOOL generateAmbientOcclusionVertexColorsWithRaysPerSample(
      NS::Integer raysPerSample, float attenuationFactor,
  ...
  BOOL generateAmbientOcclusionVertexColorsWithQuality(
      float bakeQuality, float attenuationFactor,
      const NS::Array *objectsToConsider,
      const NS::String *vertexAttributeName);

  // generateLightMapTextureWithTextureSize:lightsToConsider:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:
  BOOL generateLightMapTextureWithTextureSize(
      vector_int2 textureSize, const NS::Array *lightsToConsider,
      const NS::Array *objectsToConsider, const NS::String *vertexAttributeName,
      const NS::String *materialPropertyName);

  // generateLightMapTextureWithQuality:lightsToConsider:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:
  BOOL generateLightMapTextureWithQuality(
      float bakeQuality, const NS::Array *lightsToConsider,
      const NS::Array *objectsToConsider, const NS::String *vertexAttributeName,
      const NS::String *materialPropertyName);

  // generateLightMapVertexColorsWithLightsToConsider:objectsToConsider:vertexAttributeNamed:
  BOOL generateLightMapVertexColorsWithLightsToConsider(
      const NS::Array *lightsToConsider, const NS::Array *objectsToConsider,
      const NS::String *vertexAttributeName);
};
...
_MDL_INLINE MDL::VertexAttributeData *MDL::VertexAttributeData::alloc() {
  return NS::Object::alloc<MDL::VertexAttributeData>(
      _MDL_PRIVATE_CLS(MDLVertexAttributeData));
}
...
_MDL_INLINE void MDL::VertexAttributeData::setDataStart(const void *dataStart) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setDataStart_),
                                   dataStart);
}
...
_MDL_INLINE void
MDL::VertexAttributeData::setBufferSize(NS::UInteger bufferSize) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setBufferSize_),
                                   bufferSize);
}
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::init(class MeshBufferAllocator *bufferAllocator) {
  return Object::sendMessage<Mesh *>(
      this, _MDL_PRIVATE_SEL(initWithBufferAllocator_), bufferAllocator);
}
...
_MDL_INLINE MDL::VertexAttributeData *
MDL::Mesh::vertexAttributeDataForAttributeNamed(const NS::String *name) {
  return Object::sendMessage<VertexAttributeData *>(
      this, _MDL_PRIVATE_SEL(vertexAttributeDataForAttributeNamed_), name);
}
...
MDL::Mesh::vertexAttributeDataForAttributeNamed(const NS::String *name,
                                                VertexFormat format) {
  return Object::sendMessage<VertexAttributeData *>(
      this, _MDL_PRIVATE_SEL(vertexAttributeDataForAttributeNamed_asFormat_),
      name, format);
}

// property: boundingBox
_MDL_INLINE MDL::AxisAlignedBoundingBox MDL::Mesh::boundingBox() const {
  return Object::sendMessage<AxisAlignedBoundingBox>(
      this, _MDL_PRIVATE_SEL(boundingBox));
}

// property: vertexDescriptor
_MDL_INLINE MDL::VertexDescriptor *MDL::Mesh::vertexDescriptor() const {
  return Object::sendMessage<VertexDescriptor *>(
      this, _MDL_PRIVATE_SEL(vertexDescriptor));
}
// write method: setVertexDescriptor:
_MDL_INLINE void
MDL::Mesh::setVertexDescriptor(const VertexDescriptor *vertexDescriptor) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setVertexDescriptor_),
                                   vertexDescriptor);
}
...
_MDL_INLINE void MDL::Mesh::setVertexCount(NS::UInteger vertexCount) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setVertexCount_),
                                   vertexCount);
}
...
_MDL_INLINE NS::Array *MDL::Mesh::vertexBuffers() const {
  return Object::sendMessage<NS::Array *>(this,
                                          _MDL_PRIVATE_SEL(vertexBuffers));
}
// write method: setVertexBuffers:
_MDL_INLINE void MDL::Mesh::setVertexBuffers(const NS::Array *vertexBuffers) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setVertexBuffers_),
                                   vertexBuffers);
}

// property: allocator
_MDL_INLINE MDL::MeshBufferAllocator *MDL::Mesh::allocator() const {
  return Object::sendMessage<MeshBufferAllocator *>(
      this, _MDL_PRIVATE_SEL(allocator));
}

// property: submeshes
_MDL_INLINE NS::Array *MDL::Mesh::submeshes() const {
  return Object::sendMessage<NS::Array *>(this, _MDL_PRIVATE_SEL(submeshes));
}
// write method: setSubmeshes:
_MDL_INLINE void MDL::Mesh::setSubmeshes(const NS::Array *submeshes) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSubmeshes_),
                                   submeshes);
}
...
_MDL_INLINE void MDL::Mesh::addAttributeWithName(const NS::String *name,
  ...
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(addAttributeWithName_format_), name, format);
}
...
_MDL_INLINE void MDL::Mesh::addAttributeWithName(const NS::String *name,
                                                 ...
                                                 NS::Integer stride) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(addAttributeWithName_format_type_data_stride_),
      name, format, type, data, stride);
}

// method: addAttributeWithName:format:type:data:stride:time:
_MDL_INLINE void
MDL::Mesh::addAttributeWithName(const NS::String *name, VertexFormat format,
                                const NS::String *type, const NS::Data *data,
                                NS::Integer stride, NS::TimeInterval time) {
  return Object::sendMessage<void>(
      this,
...
_MDL_INLINE void
MDL::Mesh::addNormalsWithAttributeNamed(const NS::String *attributeName,
                                        float creaseThreshold) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(addNormalsWithAttributeNamed_creaseThreshold_),
      attributeName, creaseThreshold);
}

// method:
// addTangentBasisForTextureCoordinateAttributeNamed:tangentAttributeNamed:bitangentAttributeNamed:
_MDL_INLINE void MDL::Mesh::addTangentBasisForTextureCoordinateAttributeNamed1(
    const NS::String *textureCoordinateAttributeName,
    const NS::String *tangentAttributeName,
    const NS::String *bitangentAttributeName) {
  return Object::sendMessage<void>(
      ...
      textureCoordinateAttributeName, tangentAttributeName,
      bitangentAttributeName);
}

// method:
// addTangentBasisForTextureCoordinateAttributeNamed:normalAttributeNamed:tangentAttributeNamed:
_MDL_INLINE void MDL::Mesh::addTangentBasisForTextureCoordinateAttributeNamed2(
    const NS::String *textureCoordinateAttributeName,
    const NS::String *normalAttributeName,
    const NS::String *tangentAttributeName) {
  return Object::sendMessage<void>(
      ...
      textureCoordinateAttributeName, normalAttributeName,
      tangentAttributeName);
}

// method:
// addOrthTanBasisForTextureCoordinateAttributeNamed:normalAttributeNamed:tangentAttributeNamed:
_MDL_INLINE void MDL::Mesh::addOrthTanBasisForTextureCoordinateAttributeNamed(
    const NS::String *textureCoordinateAttributeName,
    const NS::String *normalAttributeName,
    const NS::String *tangentAttributeName) {
  return Object::sendMessage<void>(
...
_MDL_INLINE void MDL::Mesh::addUnwrappedTextureCoordinatesForAttributeNamed(
    const NS::String *textureCoordinateAttributeName) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(addUnwrappedTextureCoordinatesForAttributeNamed_),
      textureCoordinateAttributeName);
}

// method: flipTextureCoordinatesInAttributeNamed:
_MDL_INLINE void MDL::Mesh::flipTextureCoordinatesInAttributeNamed(
    const NS::String *textureCoordinateAttributeName) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(flipTextureCoordinatesInAttributeNamed_),
      textureCoordinateAttributeName);
}
...
_MDL_INLINE BOOL
MDL::Mesh::makeVerticesUniqueAndReturnError(NS::Error **error) {
  return Object::sendMessage<BOOL>(
      this, _MDL_PRIVATE_SEL(makeVerticesUniqueAndReturnError_), error);
}

// method: replaceAttributeNamed:
_MDL_INLINE void
MDL::Mesh::replaceAttributeNamed(const NS::String *name,
                                 const VertexAttributeData *newData) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(replaceAttributeNamed_), name, newData);
}

// method: updateAttributeNamed:
_MDL_INLINE void
MDL::Mesh::updateAttributeNamed(const NS::String *name,
                                const VertexAttributeData *newData) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(updateAttributeNamed_), name, newData);
}

// method: removeAttributeNamed:
_MDL_INLINE void MDL::Mesh::removeAttributeNamed(const NS::String *name) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(removeAttributeNamed_), name);
}
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initBoxWithExtent(vector_float3 extent, vector_uint3 segments,
                             BOOL inwardNormals, GeometryType geometryType,
                             class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initSphereWithExtent(vector_float3 extent, vector_uint2 segments,
                                BOOL inwardNormals, GeometryType geometryType,
                                class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
...
// method:
// initHemisphereWithExtent:segments:inwardNormals:cap:geometryType:allocator:
_MDL_INLINE MDL::Mesh *MDL::Mesh::initHemisphereWithExtent(
    vector_float3 extent, vector_uint2 segments, BOOL inwardNormals, BOOL cap,
    GeometryType geometryType, class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
      _MDL_PRIVATE_SEL(
...
// initCylinderWithExtent:segments:inwardNormals:topCap:bottomCap:geometryType:allocator:
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initCylinderWithExtent(vector_float3 extent, vector_uint2 segments,
                                  BOOL inwardNormals, BOOL topCap,
                                  BOOL bottomCap, GeometryType geometryType,
                                  class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
      _MDL_PRIVATE_SEL(
...
// initCapsuleWithExtent:cylinderSegments:hemisphereSegments:inwardNormals:geometryType:allocator:
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initCapsuleWithExtent(vector_float3 extent, vector_uint2 segments,
                                 int hemisphereSegments, BOOL inwardNormals,
                                 GeometryType geometryType,
                                 class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      ...
      extent, segments, hemisphereSegments, inwardNormals, geometryType,
      allocator);
}

// method: initConeWithExtent:segments:inwardNormals:geometryType:allocator:
_MDL_INLINE MDL::Mesh *MDL::Mesh::initConeWithExtent(
    vector_float3 extent, vector_uint2 segments, BOOL inwardNormals, BOOL cap,
    GeometryType geometryType, class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initPlaneWithExtent(vector_float3 extent, vector_uint2 segments,
                               GeometryType geometryType,
                               class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initIcosahedronWithExtent(vector_float3 extent, BOOL inwardNormals,
                                     GeometryType geometryType,
                                     class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::initMeshBySubdividingMesh(const Mesh *mesh, int submeshIndex,
                                     unsigned int subdivisionLevels,
                                     class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      this,
...
// newBoxWithDimensions:segments:geometryType:inwardNormals:allocator:
_MDL_INLINE MDL::Mesh *
MDL::Mesh::newBoxWithDimensions(vector_float3 dimensions, vector_uint3 segments,
                                GeometryType geometryType, BOOL inwardNormals,
                                class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      _MDL_PRIVATE_CLS(MDLMesh),
      _MDL_PRIVATE_SEL(
...
// static method:
// newEllipsoidWithRadii:radialSegments:verticalSegments:geometryType:inwardNormals:hemisphere:allocator:
_MDL_INLINE MDL::Mesh *MDL::Mesh::newEllipsoidWithRadii(
    vector_float3 radii, NS::UInteger radialSegments,
    NS::UInteger verticalSegments, GeometryType geometryType,
    BOOL inwardNormals, BOOL hemisphere, class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      _MDL_PRIVATE_CLS(MDLMesh),
      _MDL_PRIVATE_SEL(
          newEllipsoidWithRadii_radialSegments_verticalSegments_geometryType_inwardNormals_hemisphere_allocator_),
      radii, radialSegments, verticalSegments, geometryType, inwardNormals,
      hemisphere, allocator);
}

// static method:
// newCylinderWithHeight:radii:radialSegments:verticalSegments:geometryType:inwardNormals:allocator:
_MDL_INLINE MDL::Mesh *MDL::Mesh::newCylinderWithHeight(
    float height, vector_float2 radii, NS::UInteger radialSegments,
    NS::UInteger verticalSegments, GeometryType geometryType,
    BOOL inwardNormals, class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      ...
      height, radii, radialSegments, verticalSegments, geometryType,
      inwardNormals, allocator);
}

// static method:
// newCapsuleWithHeight:radii:radialSegments:verticalSegments:hemisphereSegments:geometryType:inwardNormals:allocator:
_MDL_INLINE MDL::Mesh *MDL::Mesh::newCapsuleWithHeight(
    float height, vector_float2 radii, NS::UInteger radialSegments,
    NS::UInteger verticalSegments, NS::UInteger hemisphereSegments,
    GeometryType geometryType, BOOL inwardNormals,
    class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      _MDL_PRIVATE_CLS(MDLMesh),
      ...
      height, radii, radialSegments, verticalSegments, hemisphereSegments,
      geometryType, inwardNormals, allocator);
}

// static method:
// newEllipticalConeWithHeight:radii:radialSegments:verticalSegments:geometryType:inwardNormals:allocator:
_MDL_INLINE MDL::Mesh *MDL::Mesh::newEllipticalConeWithHeight(
    float height, vector_float2 radii, NS::UInteger radialSegments,
    NS::UInteger verticalSegments, GeometryType geometryType,
    BOOL inwardNormals, class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
...
_MDL_INLINE MDL::Mesh *MDL::Mesh::newPlaneWithDimensions(
    vector_float2 dimensions, vector_uint2 segments, GeometryType geometryType,
    class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      _MDL_PRIVATE_CLS(MDLMesh),
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::newIcosahedronWithRadius(float radius, BOOL inwardNormals,
                                    GeometryType geometryType,
                                    class MeshBufferAllocator *allocator) {
  return Object::sendMessage<Mesh *>(
      _MDL_PRIVATE_CLS(MDLMesh),
...
_MDL_INLINE MDL::Mesh *
MDL::Mesh::newSubdividedMesh(const Mesh *mesh, NS::UInteger submeshIndex,
                             NS::UInteger subdivisionLevels) {
  return Object::sendMessage<Mesh *>(
      _MDL_PRIVATE_CLS(MDLMesh),
      _MDL_PRIVATE_SEL(newSubdividedMesh_submeshIndex_subdivisionLevels_), mesh,
      submeshIndex, subdivisionLevels);
}
...
// method:
// generateAmbientOcclusionTextureWithSize:raysPerSample:attenuationFactor:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:
_MDL_INLINE BOOL MDL::Mesh::generateAmbientOcclusionTextureWithSize(
    vector_int2 textureSize, NS::UInteger raysPerSample,
    float attenuationFactor, const NS::Array *objectsToConsider,
    const NS::String *vertexAttributeName,
    const NS::String *materialPropertyName) {
  return Object::sendMessage<BOOL>(
      ...
      textureSize, raysPerSample, attenuationFactor, objectsToConsider,
      vertexAttributeName, materialPropertyName);
}

// method:
// generateAmbientOcclusionTextureWithQuality:attenuationFactor:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:
_MDL_INLINE BOOL MDL::Mesh::generateAmbientOcclusionTextureWithQuality(
    float bakeQuality, float attenuationFactor,
    const NS::Array *objectsToConsider, const NS::String *vertexAttributeName,
    const NS::String *materialPropertyName) {
  return Object::sendMessage<BOOL>(
...
// generateAmbientOcclusionVertexColorsWithRaysPerSample:attenuationFactor:objectsToConsider:vertexAttributeNamed:
_MDL_INLINE BOOL
MDL::Mesh::generateAmbientOcclusionVertexColorsWithRaysPerSample(
    NS::Integer raysPerSample, float attenuationFactor,
    const NS::Array *objectsToConsider, const NS::String *vertexAttributeName) {
  return Object::sendMessage<BOOL>(
      this,
...
// method:
// generateAmbientOcclusionVertexColorsWithQuality:attenuationFactor:objectsToConsider:vertexAttributeNamed:
_MDL_INLINE BOOL MDL::Mesh::generateAmbientOcclusionVertexColorsWithQuality(
    float bakeQuality, float attenuationFactor,
    const NS::Array *objectsToConsider, const NS::String *vertexAttributeName) {
  return Object::sendMessage<BOOL>(
      this,
...
// method:
// generateLightMapTextureWithTextureSize:lightsToConsider:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:
_MDL_INLINE BOOL MDL::Mesh::generateLightMapTextureWithTextureSize(
    vector_int2 textureSize, const NS::Array *lightsToConsider,
    const NS::Array *objectsToConsider, const NS::String *vertexAttributeName,
    const NS::String *materialPropertyName) {
  return Object::sendMessage<BOOL>(
      ...
      textureSize, lightsToConsider, objectsToConsider, vertexAttributeName,
      materialPropertyName);
}

// method:
// generateLightMapTextureWithQuality:lightsToConsider:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:
_MDL_INLINE BOOL MDL::Mesh::generateLightMapTextureWithQuality(
    float bakeQuality, const NS::Array *lightsToConsider,
    const NS::Array *objectsToConsider, const NS::String *vertexAttributeName,
    const NS::String *materialPropertyName) {
  return Object::sendMessage<BOOL>(
      ...
      bakeQuality, lightsToConsider, objectsToConsider, vertexAttributeName,
      materialPropertyName);
}

// method:
// generateLightMapVertexColorsWithLightsToConsider:objectsToConsider:vertexAttributeNamed:
_MDL_INLINE BOOL MDL::Mesh::generateLightMapVertexColorsWithLightsToConsider(
    const NS::Array *lightsToConsider, const NS::Array *objectsToConsider,
    const NS::String *vertexAttributeName) {
  return Object::sendMessage<BOOL>(
      this,
...
//////@property (nonatomic) NSUInteger bufferSize API_AVAILABLE(macos(10.13),
/// ios(11.0), tvos(11.0));
//////
//////@end
////
...
//////// @discussion Includes a collection of submeshs which have indexbuffer
/// and
...
////////*/
////////
////////- (instancetype)initWithBufferAllocator:(nullable
/// id<MDLMeshBufferAllocator>)bufferAllocator;
////////
/////////*!
//////// @method initWithVertexBuffer:vertexCount:descriptor:submeshes:
//////// @abstract Initialize object with a vertex buffer and a collection of
/// submeshes
//////// @return Initialized mesh or nil if descriptor's layout array does not
/// describe
////////         a single buffer
//////// @param vertexBuffer MDLMeshBuffer object containing all vertex data for
/// the mesh
//////// @param vertexCount Number of vertices in the vertexBuffer
//////// @param descriptor VertexDescriptor specifying how to interpret vertex
/// data
//////// @param submeshes Array of submeshes with index buffers referencing
/// vertex data
...
/////////*!
//////// @method initWithVertexBuffer:vertexCount:descriptor:submeshes:
//////// @abstract Initialize object with an array of vertex buffers (Structure
/// of
////////           Arrays) and a collection of submeshes
//////// @return Initialized mesh or nil if descriptor's layout array is
/// incompatible
...
/// vertex data
////////        and/or materials to be applied to mesh
//////// @discussion Allows initialization with the layout of the vertexBuffers
/// in a
////////        structure-of-arrays form, in other words, non-interleaved vertex
/// attributes
//////// */
////////- (instancetype)initWithVertexBuffers:(NSArray<id<MDLMeshBuffer>>
///*)vertexBuffers
////////                          vertexCount:(NSUInteger)vertexCount
////////                           descriptor:(MDLVertexDescriptor *)descriptor
////////                            submeshes:(NSArray<MDLSubmesh*> *)submeshes;
...
/////////*!
//////// @method vertexAttributeDataForAttributeNamed:
//////// @abstract convenience selector to get quick access to vertex attribute
/// data
//////// @discussion the vertex buffer will remain mapped until the
...
//////// @discussion If the desired format has less elements than the source
/// attribute
////////             elements, excess elements will be discarded. If the desired
/// format
////////             has more elements than the source attribute, then the
/// destination
////////             elements will be set to zero.
////////             The vertex buffer will remain mapped until the
/// MDLVertexAttributeData
////////             is freed.
//////// */
////////- (nullable
...
//////// @discussion Calculated by iterating through MDLVertexAttributePosition
/// to find
////////             min and max bounds. If no attribute is named
/// MDLVertexAttributePosition
////////             this will be a invalid bounds where maxBounds is less than
/// minBounds.
//////// */
...
/////////*!
//////// @property vertexDescriptor
//////// @abstract Immutable vertex descriptor for interpreting data in
/// vertexBuffers
//////// @discussion Setting this applies the new layout in 'vertexBuffers' thus
/// is a
////////             heavyweight operation as structured copies of almost all
/// vertex
////////             buffer data could be made.  Additionally, if the new
/// vertexDescriptor
////////             does not have an attribute in the original
/// vertexDescriptor, that
////////             attribute will be deleted.  If the original
/// vertexDescriptor does
////////             not have an attribute in the new vertexDescriptor, the data
/// for the
////////             added attribute set as the added attribute's
/// initializationValue
////////             property.
////////
////////             The allocator associated with each original meshbuffer is
/// used to
////////             reallocate the corresponding resultant meshbuffer.
//////// */
////////@property (nonatomic, readwrite, copy) MDLVertexDescriptor
///*vertexDescriptor;
//////
///////*!
////// @property vertexCount
////// @abstract Number of vertices in the vertexBuffers
////// @discussion The size of vertex data in each buffer can be computed by
/// multiplying
//////             this value with the stride of the buffer in the
/// vertexDescriptor's
//////             layout
////// */
...
////// @discussion The vertex buffers in this array are indexed by the vertex
/// descriptor.
////// */
//////@property (nonatomic, readwrite, retain) NSArray<id<MDLMeshBuffer>>
///*vertexBuffers;
//////
///////*!
////// @property submeshes
////// @abstract Array of submeshes containing an indexbuffer referencing the
/// vertex
//////           data and material to be applied when the mesh is rendered
////// */
//////@property (nonatomic, copy, nullable) NSMutableArray<MDLSubmesh*>
///*submeshes;
//////
///////*!
////// @property allocator
...
////// */
//////@property (nonatomic, readonly, retain) id<MDLMeshBufferAllocator>
/// allocator;
//////
//////@end
////
...
////// @discussion The mesh's allocator will be used to create storage for the
/// new
//////             attribute.
////// */
...
///////*!
////// @method addAttributeWithName:format:type:data:stride
////// @abstract Create a new vertex attribute including an associated buffer
/// with
//////           a copy of the supplied data, and update the vertex descriptor
/// accordingly
////// @param name The name the attribute can be found by
////// @param format Format of the data, such as MDLVertexFormatFloat3
////// @param type The usage of the attribute, such as
/// MDLVertexAttributePosition
////// @param data Object containing the data to be used in the new vertex
/// buffer
...
////// @discussion Adding an attribute, such as position data, at multiple times
/// will
//////             result in attributes being created for each of those times.
//////             Attributes corresponding to multiple times can be retrieved
/// from
...
////// @param attributeName Name is the attribute name of vertex normal
/// attribute.  If nil, vertex normals
//////        will be added with the MDLVertexAttributeNormal name string
////// @param creaseThreshold Threshold of the dot product between the 2
/// triangles after which
//////                        their face normal will be smoothed out. Therefore,
/// a threshold of 0 will
//////                        smooth everything and a threshold of 1 won't
/// smooth anything.
////// @discussion Uses the attribute named MDLVertexAttributePosition to
/// calculate
//////             vertex normals. If the mesh does not have an attribute with
//////             'attributeName', it will be added, otherwise the attribute
/// name will
//////             be overwritten with vertex normal data. 'vertexDescriptor'
/// will be
...
/*!
 @method
 addTangentBasisForTextureCoordinateAttributeNamed:tangentAttributeNamed:bitangentAttributeNamed
 @abstract Create a shader basis where the tangent and bitangent span the uv ->
 object space transform
 @param textureCoordinateAttributeName Name of texture coordinates to use in
 calculations
 ...
 @discussion Uses the attribute named MDLVertexAttributePosition and
             ...
             the new attributes if necessary. The basis may not be orthogonal;
 to gaurantee an orthogonal tangent basis please use
 addOrthTanBasisForTextureCoordinateAttibuteNamed selector.
 */
//-
//(void)addTangentBasisForTextureCoordinateAttributeNamed:(NSString*)textureCoordinateAttributeName
//                                    tangentAttributeNamed:(NSString
//                                    *)tangentAttributeName
//                                  bitangentAttributeNamed:(nullable NSString
//                                  *)bitangentAttributeName;
//
///*!
// @method
...
// @param textureCoordinateAttributeName texture coordinates to use in
// calculations
// @param normalAttributeName normals to use in calculations
// @param tangentAttributeName Name of a four component vertex tangent
// attribute.
// @discussion Uses the attribute named MDLVertexAttributePosition and
//             textureCoordinateAttributeName and the specified normals to
//             calculate tangent information. The mesh's vertexDescriptor will
//             be updated to reflect the new attribute if necessary. Note that
//             this method does NOT produce a T.w component which is used in B =
//             (N x T) * T.w Please use
...
/// calculations
//////@param normalAttributeName normals to use in calculations
//////@param tangentAttributeName Name of a three/four component vertex tangent
/// attribute.
//////@discussion Uses the attribute named MDLVertexAttributePosition and
//////            textureCoordinateAttributeName and the specified normals to
/// calculate
//////            tangent information. The mesh's vertexDescriptor will be
/// updated to
...
//////*/
//////- (void)addOrthTanBasisForTextureCoordinateAttributeNamed:(NSString
///*)textureCoordinateAttributeName
//////                                     normalAttributeNamed:(NSString
///*)normalAttributeName
//////                                    tangentAttributeNamed:(NSString
///*)tangentAttributeName API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0));
//////
///////*!
////// @method
...
////// @param textureCoordinateAttributeName texture coordinates to modify or
/// create
////// @discussion Uses the attribute named MDLVertexAttributePosition and if
/// available,
//////             the attribute named MDLVertexAttributeNormal to calculate
/// texture coordinates
////// */
//////-
...
///////*!
////// @method flipTextureCoordinatesInAttributeNamed:
////// @abstract Flips texture coordinates by performing the operation (u,v) =
///(u, 1-v)
////// @param textureCoordinateAttributeName texture coordinates to modify
////// @discussion Many application generate model files with texture coordinate
/// mapping
//////             assuming a bottom left bitmap origin. It can be more
/// convenient to
//////             have texture coordinates corresponding to an upper left
/// bitmap origin.
//////             This selector will perform the flip operation if the
/// requested texture
//////             coordinate attribute exists on the mesh. An exception will be
/// raised if
...
//////             vertices so faces do not share vertices. The vertex buffer
/// and index
//////             buffers on submeshes may grow to accomadate any vertices
/// added.
////// */
...
////// @abstract replace existing attribute data with new attribute data
/// retaining
...
////// @abstract update existing attribute data with new attribute data
/// retaining
...
/////*!
//// @method
/// initBoxMeshWithExtent:segments:inwardNormals:geometryType:allocator: /
///@abstract Factory method for generating a mesh with a cube shape / @return
/// MDLMesh box with desired attributes / @param extent size of the box in each
/// dimension / @param segments Number of slices in each dimension / @param
/// inwardNormals Generated Normal point inward / @param geometryType Can be
/// MDLGeometryTypeLines, MDLGeometryTypeQuads, or MDLGeometryTypeTriangles /
///@param allocator A mesh buffer allocator used to allocate memory to back
/// buffers /        for the returned mesh.  If nil, a default allocator will be
/// used / @discussion Assembled with triangle or quad primitives.  Specifying
/// inward /             normals is useful for generating a skybox. The center
/// of the box /             is at(0, 0, 0). /             Will raise an
/// exception if an unsupported geometry type is passed in. / */
...
//// @param geometryType Must be MDLGeometryTypeTriangles or
/// MDLGeometryTypeLines / @param inwardNormals If true, generated normals will
/// face inwards. Useful for /        generating a skydome. /        actual
/// nubmer of vertical slices will be half of 'vertical' segments / @param
/// allocator A mesh buffer allocator used to allocate memory to back buffers /
/// for the returned mesh.  If nil, a default allocator will be used /
///@discussion Specifying inward normals and hemisphere is useful for generating
/// a skydome. /             Specifying equal X, Y, and Z radii will generate a
/// sphere. /             Specifying a y radius of 0.0 will generate a disc. /
...
//// @param geometryType Must be MDLGeometryTypeTriangles or
/// MDLGeometryTypeLines / @param inwardNormals Normals point toward center of
/// cylinder / @param allocator A mesh buffer allocator used to allocate memory
/// to back buffers /        for the returned mesh.  If nil, a default allocator
/// will be used / @discussion Center of cylinder at (0, 0, 0) with a top at +Y
/// and bottom at -Y. /             Specifying equal X and Z radia will generate
/// a true cylinder. /             Specifying a height of 0.0 and
/// verticalSegments of 0 will generate /             a disc. /             Will
/// raise an exception if radialSegments is < 3 or if an unsupported / geometry
/// type is passed in. /             Generated texture coordinates are laid out
/// as follows: /                                                      ___ / / \
///<- T texcoord = 0.0 /                 Texture for top of cylinder   ---> [ ]
////                                                     \___/
////                                                    [     ]  <- T texcoord =
/// 0.3333 /                                                    [     ] /
/// Texture for sides of cylinder ---> [     ] / [_____]  <- T texcoord = 0.6666
////                                                     /   \
...
// @method
// initCapsuleWithExtent:cylinderSegments:hemisphereSegments:inwardNormals:geometryType:allocator
// @abstract Factory method for generating a mesh with a capsule shape; a
// cylinder
...
// @param hemisphereSegments Number of slices through hemisphere caps along Y
// axis
...
//             The height of hemisphere cap is specified by the minimum of X and
//             Z Specifying equal X and Z radii will generate a true capsule.
//             Specifying a height that is less than the twice of min of the X
//             and Z radii or verticalSegments of 0 will generate a sphere. The
//             full height of the capsule will also incorporate the hemisphere
//             caps. Will raise an exception if radialSegments is < 3 or if
//             hemisphereSegments < 1 or if an unsupported geometry type is
//             specified. Generated texture coordinates for top and bottom caps
//             are wrapped in a similar manner as for asphere, laid out as
//             follows:
//                                      ___
//                                     /   \   <- T texcoord = 0.0
...
//// @param geometryType Must be MDLGeometryTypeTriangles or
/// MDLGeometryTypeLines / @param inwardNormals Normals point toward center of
/// ellipticalCone / @param allocator A mesh buffer allocator used to allocate
/// memory to back buffers /        for the returned mesh.  If nil, a default
/// allocator will be used / @discussion Point of cone at (0, 0, 0) while base
/// of cone is -Y. /             Will raise an exception if radialSegments is <
/// 3, or verticalSegments is < 1, /             or if an unsupported geometry
/// type is passed in. /             Generated texture coordinates are laid out
/// as follows: /                                                 _____ / [ ] <-
/// T texcoord = 0.0 /                                                [     ] /
/// Texture for sides of cone ---> [     ] / [     ] / [_____]  <- T texcoord =
/// 0.6666
////                                                 /   \
...
//// @param geometryType Can be MDLGeometryTypeLines, MDLGeometryTypeQuads, or
/// MDLGeometryTypeTriangles / @param allocator A mesh buffer allocator used to
/// allocate memory to back buffers /        for the returned mesh.  If nil, a
/// default allocator will be used / @discussion Creates a plane spanning the
/// greatest dimensions of extent. /             Will raise an exception if an
/// unsupported geometry type is passed in. / */
...
//// @param inwardNormals Generated normals will face towards the center of the
/// mesh / @param allocator A mesh buffer allocator used to allocate memory to
/// back buffers /        for the returned mesh.  If nil, a default allocator
/// will be used / @discussion  Creates an icosahedron with center at (0, 0, 0).
//// */
...
// @discussion Subdivision levels over four are likely to generate more
// triangles
...
//             using the topology preservation flag set to YES will result in
//             the best subdivision results.
...
////                       inwardNormals:(BOOL)inwardNormals
////                           allocator:(nullable
/// id<MDLMeshBufferAllocator>)allocator API_AVAILABLE(macos(10.13), ios(11.0),
/// tvos(11.0));
...
// @abstract Creates an Ambient Occlusion texture, returns true upon success,
// false
//           upon failure
// @param textureSize Texture Size in which to bake the ambient occlusion
// @param raysPerSample Number of rays to be sent out of every texture texel
// against
//        the object for potential occlusion.
// @param attenuationFactor Float between 0 to 1 that defines how to attenuate
// the
//        AO value. 0 doesn't change it, and at 1, all AO values are white
//        except if they are originally completely black. Quadratic attenuation
//        in between.
// @param objectsToConsider NSArray of MDLMeshes containing the objects to
// raytrace against
// @param vertexAttributeName NSString of the MDLVertexAttribute where the
// vertex
//        texture UVs will be stored. Creates it if it doesn't exist, otherwise
//        overwrites current values.
// @param materialPropertyName NSString of the MDLMaterialProperty that will
// store
...
/*!
 ...
 @abstract Creates an Ambient Occlusion texture, returns true upon success,
 false upon failure
 @param bakeQuality Float between 0 and 1 that defines quality of the bake
 process. 0 is of lower quality but bakes faster and uses less memory, where 1
 ...
 @param attenuationFactor Float between 0 to 1 that defines how to attenuate the
        ...
        if they are originally completely black. Quadratic attenuation in
 between.
 @param objectsToConsider NSArray of MDLMeshes containing the objects to
 raytrace against
