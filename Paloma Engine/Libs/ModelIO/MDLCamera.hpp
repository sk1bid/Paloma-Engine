...
_MDL_INLINE matrix_float4x4 MDL::Camera::projectionMatrix() const {
  return Object::sendMessage<matrix_float4x4>(
      this, _MDL_PRIVATE_SEL(projectionMatrix));
}

// property: projection
_MDL_INLINE MDL::CameraProjection MDL::Camera::projection() const {
  return Object::sendMessage<CameraProjection>(this,
                                               _MDL_PRIVATE_SEL(projection));
}
// write method: setProjection:
_MDL_INLINE void MDL::Camera::setProjection(CameraProjection projection) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setProjection_),
                                   projection);
}

// method: frameBoundingBox:setNearAndFar:
_MDL_INLINE void
MDL::Camera::frameBoundingBox(AxisAlignedBoundingBox boundingBox,
                              BOOL setNearAndFar) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(frameBoundingBox_setNearAndFar_), boundingBox,
      setNearAndFar);
}

// method: lookAt:
_MDL_INLINE void MDL::Camera::lookAt(vector_float3 focusPosition) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(lookAt_),
                                   focusPosition);
}
...
_MDL_INLINE void MDL::Camera::lookAt(vector_float3 focusPosition,
  ...
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(lookAt_from_),
                                   focusPosition, cameraPosition);
}

// method: rayTo:forViewPort:
_MDL_INLINE vector_float3 MDL::Camera::rayTo(vector_int2 pixel,
                                             vector_int2 size) {
  return Object::sendMessage<vector_float3>(
      this, _MDL_PRIVATE_SEL(rayTo_forViewPort_), pixel, size);
}
...
_MDL_INLINE float MDL::Camera::nearVisibilityDistance() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(nearVisibilityDistance));
}
// write method: setNearVisibilityDistance:
_MDL_INLINE void
MDL::Camera::setNearVisibilityDistance(float nearVisibilityDistance) {
  return Object::sendMessage<void>(this,
                                   _MDL_PRIVATE_SEL(setNearVisibilityDistance_),
...
_MDL_INLINE float MDL::Camera::farVisibilityDistance() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(farVisibilityDistance));
}
// write method: setFarVisibilityDistance:
_MDL_INLINE void
MDL::Camera::setFarVisibilityDistance(float farVisibilityDistance) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setFarVisibilityDistance_), farVisibilityDistance);
}
...
_MDL_INLINE float MDL::Camera::worldToMetersConversionScale() const {
  return Object::sendMessage<float>(
      this, _MDL_PRIVATE_SEL(worldToMetersConversionScale));
}
// write method: setWorldToMetersConversionScale:
_MDL_INLINE void MDL::Camera::setWorldToMetersConversionScale(
    float worldToMetersConversionScale) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setWorldToMetersConversionScale_),
...
_MDL_INLINE void MDL::Camera::setBarrelDistortion(float barrelDistortion) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setBarrelDistortion_),
                                   barrelDistortion);
}
...
_MDL_INLINE void MDL::Camera::setFisheyeDistortion(float fisheyeDistortion) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setFisheyeDistortion_), fisheyeDistortion);
}
...
_MDL_INLINE void MDL::Camera::setOpticalVignetting(float opticalVignetting) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setOpticalVignetting_), opticalVignetting);
}

// property: chromaticAberration
_MDL_INLINE float MDL::Camera::chromaticAberration() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(chromaticAberration));
}
// write method: setChromaticAberration:
_MDL_INLINE void
MDL::Camera::setChromaticAberration(float chromaticAberration) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setChromaticAberration_), chromaticAberration);
}
...
_MDL_INLINE void MDL::Camera::setFocalLength(float focalLength) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFocalLength_),
                                   focalLength);
}
...
_MDL_INLINE void MDL::Camera::setFocusDistance(float focusDistance) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFocusDistance_),
                                   focusDistance);
}
...
_MDL_INLINE void MDL::Camera::setFieldOfView(float fieldOfView) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFieldOfView_),
                                   fieldOfView);
}
...
_MDL_INLINE NS::UInteger MDL::Camera::apertureBladeCount() const {
  return Object::sendMessage<NS::UInteger>(
      this, _MDL_PRIVATE_SEL(apertureBladeCount));
}
// write method: setApertureBladeCount:
_MDL_INLINE void
MDL::Camera::setApertureBladeCount(NS::UInteger apertureBladeCount) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setApertureBladeCount_), apertureBladeCount);
}

// property: maximumCircleOfConfusion
_MDL_INLINE float MDL::Camera::maximumCircleOfConfusion() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(maximumCircleOfConfusion));
}
// write method: setMaximumCircleOfConfusion:
_MDL_INLINE void
MDL::Camera::setMaximumCircleOfConfusion(float maximumCircleOfConfusion) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setMaximumCircleOfConfusion_),
...
_MDL_INLINE MDL::Texture *MDL::Camera::bokehKernelWithSize(vector_int2 size) {
  return Object::sendMessage<Texture *>(
      this, _MDL_PRIVATE_SEL(bokehKernelWithSize_), size);
}

// property: shutterOpenInterval
_MDL_INLINE NS::TimeInterval MDL::Camera::shutterOpenInterval() const {
  return Object::sendMessage<NS::TimeInterval>(
      this, _MDL_PRIVATE_SEL(shutterOpenInterval));
}
// write method: setShutterOpenInterval:
_MDL_INLINE void
MDL::Camera::setShutterOpenInterval(NS::TimeInterval shutterOpenInterval) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setShutterOpenInterval_), shutterOpenInterval);
}

// property: sensorVerticalAperture
_MDL_INLINE float MDL::Camera::sensorVerticalAperture() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(sensorVerticalAperture));
}
// write method: setSensorVerticalAperture:
_MDL_INLINE void
MDL::Camera::setSensorVerticalAperture(float sensorVerticalAperture) {
  return Object::sendMessage<void>(this,
                                   _MDL_PRIVATE_SEL(setSensorVerticalAperture_),
...
_MDL_INLINE vector_float2 MDL::Camera::sensorEnlargement() const {
  return Object::sendMessage<vector_float2>(
      this, _MDL_PRIVATE_SEL(sensorEnlargement));
}
// write method: setSensorEnlargement:
_MDL_INLINE void
MDL::Camera::setSensorEnlargement(vector_float2 sensorEnlargement) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setSensorEnlargement_), sensorEnlargement);
}
...
_MDL_INLINE vector_float2 MDL::Camera::exposureCompression() const {
  return Object::sendMessage<vector_float2>(
      this, _MDL_PRIVATE_SEL(exposureCompression));
}
// write method: setExposureCompression:
_MDL_INLINE void
MDL::Camera::setExposureCompression(vector_float2 exposureCompression) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setExposureCompression_), exposureCompression);
}
...
_MDL_INLINE MDL::StereoscopicCamera *MDL::StereoscopicCamera::alloc() {
  return NS::Object::alloc<MDL::StereoscopicCamera>(
      _MDL_PRIVATE_CLS(MDLStereoscopicCamera));
}
...
_MDL_INLINE float MDL::StereoscopicCamera::interPupillaryDistance() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(interPupillaryDistance));
}
// write method: setInterPupillaryDistance:
_MDL_INLINE void MDL::StereoscopicCamera::setInterPupillaryDistance(
    float interPupillaryDistance) {
  return Object::sendMessage<void>(this,
                                   _MDL_PRIVATE_SEL(setInterPupillaryDistance_),
...
_MDL_INLINE void MDL::StereoscopicCamera::setLeftVergence(float leftVergence) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setLeftVergence_),
                                   leftVergence);
}
...
_MDL_INLINE void
MDL::StereoscopicCamera::setRightVergence(float rightVergence) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setRightVergence_),
                                   rightVergence);
}
...
_MDL_INLINE void MDL::StereoscopicCamera::setOverlap(float overlap) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setOverlap_),
                                   overlap);
}
...
_MDL_INLINE matrix_float4x4 MDL::StereoscopicCamera::leftViewMatrix() const {
  return Object::sendMessage<matrix_float4x4>(this,
                                              _MDL_PRIVATE_SEL(leftViewMatrix));
}

// property: rightViewMatrix
_MDL_INLINE matrix_float4x4 MDL::StereoscopicCamera::rightViewMatrix() const {
  return Object::sendMessage<matrix_float4x4>(
      this, _MDL_PRIVATE_SEL(rightViewMatrix));
}

// property: leftProjectionMatrix
_MDL_INLINE matrix_float4x4
MDL::StereoscopicCamera::leftProjectionMatrix() const {
  return Object::sendMessage<matrix_float4x4>(
      this, _MDL_PRIVATE_SEL(leftProjectionMatrix));
}

// property: rightProjectionMatrix
_MDL_INLINE matrix_float4x4
MDL::StereoscopicCamera::rightProjectionMatrix() const {
  return Object::sendMessage<matrix_float4x4>(
      this, _MDL_PRIVATE_SEL(rightProjectionMatrix));
}
...
//
// @discussion Values are represented as float in MDLCamera as it offers
// sufficient precision, and because calculations will be identical on any
// processor architecture. This consistency is a requirement of the model.
//
// MDLCamera provides the a model of the parameters governing the physical
// process of transforming a scene into an image.
//
...
//              visible object
//
//    Those objects existing between nearVisibilityDistance and
//    farVisibilityDistance are considered to be visible. All lights are
//    considered, irrespective of nearVisibilityDistance and
//    farVisibilityDistance, to compute scene luminance.
//
//    @property worldToMetersConversionScale
//
//    Some calculations, such as the calculation of stereo view matrices,
//    require calculations to occur in world space. Significant quantities
//    measured in mm therefore use this conversion scale to perform the
//    calculation. The default value is 1.0.
//
...
//    @property fisheyeDistortion
//
//    Illuminated objects result in scene luminance, which passes through the
//    lens. All lenses impose some amount of radial distortion which can be
//    computed from focal length. However, some lenses introduce error, and
//    radial distortion can be used as an aesthetic control as well. Therefore
//    radial distortion is provided as a property. If r is the radial distance
//    of a pixel from the center of the projection, then radial distortion is
//    computed as
//
//         r' = r * (1 + barrelDistorion * r^2 + fisheyeDistortion * r^4)
//
//    radialDistortion sufficiently describes the distortion characteristic of
//    most lenses. In order to simulate certain other lenses, such as those
//    found in security cameras, fisheye lenses, plastic toy lenses, sport
//    cameras, or some VR headsets, radialDistortion2 is introduced.
//
...
//    @property opticalVignetting
//
//    Optical vignetting occurs to some degree in all lenses. It results from
//    light at the edge of an image being blocked as it travels past the lens
//    hood and the internal lens apertures. It is more prevalent with wide
//    apertures. A value of zero indicates no optical vignetting is occuring,
//    and a value of one indicates that vignetting affects all locations in the
//    image according to radial distance. Optical vignetting also occurs in head
//    mounted displays, and the value here can be used as an intended amount of
//    vignetting to apply to an image.
//
//    @property chromaticAberration
//
//    Chromatic aberration occurs to some degree in all lenses. It results from
//    a lens bringing different wavelengths of light to focus at different
//    places on the image plane. A value of zero indicates no chromatic
//    aberration is occurring, and one indicates maximum. Chromatic aberration
//    affects all locations in the image according to radial distance. Chromatic
//    aberration also occurs in head mounted displays, and the value here can be
//    used as an intended amount of chromatic aberration to apply to an image.
//
...
//    @property focusDistance
//
//    The distance, in meters, at which the lens is focused. The default
//    is 2.5m.
//
//    @property fieldOfView
//
//    The field of view is calculated from the focal length and sensor aperture.
//    Changing the field of view will update the focalLength property with
//    respect to the sensor aperture. The default is 54 degrees, corresponding
//    to a focal length of 50mm, and a vertical sensor aperture of 24mm.
//
//    @property fStop
//
...
//    reaches the sensor, as well as the size of out of focus parts of the
//    image. The diameter of the entrance pupil, is therefore obtained by
//    dividing the fStop by the focalLength.
//
// 5. Lens exit aperture
//
//    @property apertureBladeCount
//
//    The shape of out of focus highlights in a scene is commonly known as
//    "bokeh". The aesthetic quality of a lens' bokeh is one of the
//    characteristics that drives the choice of a lens for a particular scene.
//    To a large degree, the appearance of bokeh is governed by the shape of the
//    lens aperture. Typical lens apertures are controlled by a series of
//    overlapping blades that can be irised open and closed. A lens with a five
//    blade aperture will yield a five sided bokeh. The default is zero, which
//    is to be interpreted as a perfectly round aperture.
//
//    Note that the effect of a filter on the front of the lens can be modeled
//    equivalently at the exit aperture. The MIOCamera does not explicitly
//    provide specification of such effects, but a simulation could incorporate
//    them at this stage.
//
//    @property maximumCircleOfConfusion
//
...
//    light that reaches the sensor and also the length of motion blur trails.
//    The shutter time is not the same thing as scene frame rate. The rule of
//    thumb for movies is that the shutter time should be half the frame rate,
//    so to achieve a "filmic" look, the shutter time choice might be 1/48 of a
//    second, since films are usually projected at 24 frames per second. Shutter
//    time is independent of simulation frame rate because motion blur trails
//    and exposure times should be held constant in order to avoid flicker
//    artifacts.
//
...
//           <- 36mm -->
//
//    Changing the aperture will update the field of view property with respect
//    to the focal length. The horizontal aperture can be calculated from the
//    aspect property.
//
...
//    projections, as well as to provide vergence in a parallel stereoscopic
//    camera.
//
// 7. Exposure
//
...
//
//    The equivalent to flash in a color grading system is known as lift.
//    Typically red, green, and blue can be controlled independently.
//
...
//    @property exposureCompression
//
//    Gamma curve compression where values below the x value are to be passed
//    through, about the y value, values are to be clamped at maximum display
//    brightness, and a function such as a logarithmic ramp is to be applied in
//    between. The default is (1,0, 1.0).
//
//    A displayable value is therefore obtained via
//       pow(exposureCompression((sensor value + flash) * exposure),
//       displayGamma)
//
// */
//
...
//
///**
// The projection matrix is calculated from the near and far visibility
// distances, and the field of view.
...
// */
//- (void)frameBoundingBox:(MDLAxisAlignedBoundingBox)boundingBox
// setNearAndFar:(BOOL)setNearAndFar;
//
///**
// Orient the camera so that the camera points at focusPosition. Assumes that
// the Y axis is up.
// */
//- (void)lookAt:(vector_float3)focusPosition;
//
///**
// Set the position of the camera and orient it so that it points at
// focusPosition. Assumes that the Y axis is up.
// */
//- (void)lookAt:(vector_float3)focusPosition
// from:(vector_float3)cameraPosition;
//
///**
...
//
///**
// exposure curve compression where values below the x value are to be passed
// through, above the y value, values are to be clamped at maximum display
// brightness, and a function such as a logarithmic ramp is to be applied in
// between.
// */
...
// binocular stereoscopic camera rotates the lens and sensor together such that
// a ray projected from the center of either sensor and lens meets at a point. A
// parallel binocular stereoscopic camera accomplishes the same thing by
// shifting the relative centers of the sensor and lens.
//
// If a parallel binocular stereoscopic camera is modeled, the sensor should be
// considered to have shifted by an amount h. If left and right vergence are
// equal,
...
//
///**
// The amount, as a percentage of image width to offset an image towards the
// other camera. This value is used in a stereo grade to enhance or reduce the
// intensity of the stereoscopic effect
// */
