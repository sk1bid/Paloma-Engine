...
public:
  ...
  textureCubeWithImagesNamed(const NS::Array *names,
                             const NS::Bundle *bundleOrNil);

  // irradianceTextureCubeWithTexture:name:dimensions:
  static class Texture *irradianceTextureCubeWithTexture(
      const Texture *texture, const NS::String *name, vector_int2 dimensions);
  ...
  class Texture *init(const NS::Data *pixelData, BOOL topLeftOrigin,
                      const NS::String *name, vector_int2 dimensions,
                      NS::UInteger rowStride, NS::UInteger channelCount,
                      TextureChannelEncoding channelEncoding, BOOL isCube);
  ...
  NS::Data *texelDataWithTopLeftOriginAtMipLevel(NS::Integer level,
                                                 BOOL create);

  // texelDataWithBottomLeftOriginAtMipLevel:create:
  NS::Data *texelDataWithBottomLeftOriginAtMipLevel(NS::Integer level,
                                                    BOOL create);
...
public:
  ...
  class CheckerboardTexture *init(float divisions, const NS::String *name,
                                  vector_int2 dimensions, int channelCount,
...
public:
  ...
  class SkyCubeTexture *
  init(const NS::String *name, TextureChannelEncoding channelEncoding,
       vector_int2 textureDimensions, float turbidity, float sunElevation,
       float upperAtmosphereScattering, float groundAlbedo);

  // initWithName:channelEncoding:textureDimensions:turbidity:sunElevation:sunAzimuth:upperAtmosphereScattering:groundAlbedo:
  class SkyCubeTexture *
  init(const NS::String *name, TextureChannelEncoding channelEncoding,
       vector_int2 textureDimensions, float turbidity, float sunElevation,
       float sunAzimuth, float upperAtmosphereScattering, float groundAlbedo);
  ...
  void
  setHighDynamicRangeCompression(vector_float2 highDynamicRangeCompression);
};
...
public:
  ...
  class ColorSwatchTexture *initWithColorTemperatureGradientFrom(
      float colorTemperature1, float colorTemperature2, const NS::String *name,
      vector_int2 textureDimensions);

  // initWithColorGradientFrom:toColor:name:textureDimensions:
  class ColorSwatchTexture *
  initWithColorGradientFrom(CGColorRef color1, CGColorRef color2,
                            const NS::String *name,
                            vector_int2 textureDimensions);

  class ColorSwatchTexture *
  initWithColorGradientFrom(float color1, float color2, const NS::String *name,
                            vector_int2 textureDimensions);
};
...
public:
  ...
  class NoiseTexture *
  initVectorNoiseWithSmoothness(float smoothness, const NS::String *name,
                                vector_int2 textureDimensions,
                                TextureChannelEncoding channelEncoding);

  // initScalarNoiseWithSmoothness:name:textureDimensions:channelCount:channelEncoding:grayscale:
  class NoiseTexture *initScalarNoiseWithSmoothness(
      float smoothness, const NS::String *name, vector_int2 textureDimensions,
      int channelCount, TextureChannelEncoding channelEncoding, BOOL grayscale);

  // initCellularNoiseWithFrequency:name:textureDimensions:channelEncoding:
  class NoiseTexture *
  initCellularNoiseWithFrequency(float frequency, const NS::String *name,
                                 vector_int2 textureDimensions,
                                 TextureChannelEncoding channelEncoding);
};
...
public:
  ...
  class NormalMapTexture *init(const Texture *sourceTexture,
                               const NS::String *name, float smoothness,
                               float contrast);
};
...
_MDL_INLINE MDL::Texture *MDL::Texture::textureNamed(const NS::String *name) {
  return Object::sendMessage<MDL::Texture *>(
      _MDL_PRIVATE_CLS(MDLTexture), _MDL_PRIVATE_SEL(textureNamed_), name);
}

// static method: textureNamed:bundle:
_MDL_INLINE MDL::Texture *
MDL::Texture::textureNamed(const NS::String *name,
                           const NS::Bundle *bundleOrNil) {
  return Object::sendMessage<MDL::Texture *>(
      _MDL_PRIVATE_CLS(MDLTexture), _MDL_PRIVATE_SEL(textureNamed_bundle_),
      name, bundleOrNil);
}
...
MDL::Texture::textureNamed(const NS::String *name,
                           class AssetResolver *resolver) {
  return Object::sendMessage<MDL::Texture *>(
      _MDL_PRIVATE_CLS(MDLTexture),
      _MDL_PRIVATE_SEL(textureNamed_assetResolver_), name, resolver);
}

// static method: textureCubeWithImagesNamed:
_MDL_INLINE MDL::Texture *
MDL::Texture::textureCubeWithImagesNamed(const NS::Array *names) {
  return Object::sendMessage<MDL::Texture *>(
      _MDL_PRIVATE_CLS(MDLTexture),
      _MDL_PRIVATE_SEL(textureCubeWithImagesNamed_), names);
}
...
MDL::Texture::textureCubeWithImagesNamed(const NS::Array *names,
  ...
  return Object::sendMessage<MDL::Texture *>(
      _MDL_PRIVATE_CLS(MDLTexture),
      _MDL_PRIVATE_SEL(textureCubeWithImagesNamed_bundle_), names, bundleOrNil);
}

// static method: irradianceTextureCubeWithTexture:name:dimensions:
_MDL_INLINE MDL::Texture *MDL::Texture::irradianceTextureCubeWithTexture(
    const Texture *texture, const NS::String *name, vector_int2 dimensions) {
  return Object::sendMessage<MDL::Texture *>(
      _MDL_PRIVATE_CLS(MDLTexture),
...
// initWithData:topLeftOrigin:name:dimensions:rowStride:channelCount:channelEncoding:isCube:
_MDL_INLINE MDL::Texture *
MDL::Texture::init(const NS::Data *pixelData, BOOL topLeftOrigin,
                   const NS::String *name, vector_int2 dimensions,
                   NS::UInteger rowStride, NS::UInteger channelCount,
                   TextureChannelEncoding channelEncoding, BOOL isCube) {
  return Object::sendMessage<Texture *>(
      this,
      _MDL_PRIVATE_SEL(
          initWithData_topLeftOrigin_name_dimensions_rowStride_channelCount_channelEncoding_isCube_),
      pixelData, topLeftOrigin, name, dimensions, rowStride, channelCount,
...
_MDL_INLINE BOOL MDL::Texture::writeToURL(const NS::URL *URL,
                                          NS::UInteger level) {
  return Object::sendMessage<BOOL>(this, _MDL_PRIVATE_SEL(writeToURL_level_),
                                   URL, level);
}

// method: writeToURL:type
_MDL_INLINE BOOL MDL::Texture::writeToURL(const NS::URL *nsurl,
                                          CFStringRef type) {
  return Object::sendMessage<BOOL>(this, _MDL_PRIVATE_SEL(writeToURL_type_),
                                   nsurl, type);
}
...
_MDL_INLINE BOOL MDL::Texture::writeToURL(const NS::URL *nsurl,
  ...
  return Object::sendMessage<BOOL>(
      this, _MDL_PRIVATE_SEL(writeToURL_type_level_), nsurl, type, level);
}

// method: imageFromTexture
_MDL_INLINE CGImageRef MDL::Texture::imageFromTexture() {
  return Object::sendMessage<CGImageRef>(this,
                                         _MDL_PRIVATE_SEL(imageFromTexture));
}

// method: imageFromTextureAtLevel:
_MDL_INLINE CGImageRef
MDL::Texture::imageFromTextureAtLevel(NS::UInteger level) {
  return Object::sendMessage<CGImageRef>(
      this, _MDL_PRIVATE_SEL(imageFromTextureAtLevel_), level);
}
...
_MDL_INLINE NS::Data *MDL::Texture::texelDataWithTopLeftOrigin() {
  return Object::sendMessage<NS::Data *>(
      this, _MDL_PRIVATE_SEL(texelDataWithTopLeftOrigin));
}

// method: texelDataWithBottomLeftOrigin
_MDL_INLINE NS::Data *MDL::Texture::texelDataWithBottomLeftOrigin() {
  return Object::sendMessage<NS::Data *>(
      this, _MDL_PRIVATE_SEL(texelDataWithBottomLeftOrigin));
}
...
_MDL_INLINE void MDL::Texture::setAsAlphaValues(BOOL hasAlphaValues) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setAsAlphaValues_),
                                   hasAlphaValues);
}
...
_MDL_INLINE MDL::URLTexture *MDL::URLTexture::init(const NS::URL *URL,
                                                   const NS::String *name) {
  return Object::sendMessage<MDL::URLTexture *>(
      this, _MDL_PRIVATE_SEL(initWithURL_name_), URL, name);
}
...
_MDL_INLINE MDL::CheckerboardTexture *MDL::CheckerboardTexture::alloc() {
  return NS::Object::alloc<MDL::CheckerboardTexture>(
      _MDL_PRIVATE_CLS(MDLCheckerboardTexture));
}

// method:
// initWithDivisions:name:dimensions:channelCount:channelEncoding:color1:color2:
_MDL_INLINE MDL::CheckerboardTexture *
MDL::CheckerboardTexture::init(float divisions, const NS::String *name,
                               vector_int2 dimensions, int channelCount,
                               TextureChannelEncoding channelEncoding,
                               CGColorRef color1, CGColorRef color2) {
  return Object::sendMessage<CheckerboardTexture *>(
      this,
      _MDL_PRIVATE_SEL(
          initWithDivisions_name_dimensions_channelCount_channelEncoding_color1_color2_),
      divisions, name, dimensions, channelCount, channelEncoding, color1,
      color2);
}
...
_MDL_INLINE void MDL::CheckerboardTexture::setDivisions(float divisions) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setDivisions_),
                                   divisions);
}
...
_MDL_INLINE MDL::SkyCubeTexture *MDL::SkyCubeTexture::alloc() {
  return NS::Object::alloc<MDL::SkyCubeTexture>(
      _MDL_PRIVATE_CLS(MDLSkyCubeTexture));
}

// method:
// initWithName:channelEncoding:textureDimensions:turbidity:sunElevation:upperAtmosphereScattering:groundAlbedo:
_MDL_INLINE MDL::SkyCubeTexture *MDL::SkyCubeTexture::init(
    const NS::String *name, TextureChannelEncoding channelEncoding,
    vector_int2 textureDimensions, float turbidity, float sunElevation,
    float upperAtmosphereScattering, float groundAlbedo) {
  return Object::sendMessage<SkyCubeTexture *>(
      this,
      _MDL_PRIVATE_SEL(
          initWithName_channelEncoding_textureDimensions_turbidity_sunElevation_upperAtmosphereScattering_groundAlbedo_),
      name, channelEncoding, textureDimensions, turbidity, sunElevation,
...
_MDL_INLINE void MDL::SkyCubeTexture::setTurbidity(float turbidity) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setTurbidity_),
                                   turbidity);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setSunElevation(float sunElevation) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSunElevation_),
                                   sunElevation);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setSunAzimuth(float sunAzimuth) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSunAzimuth_),
                                   sunAzimuth);
}
...
_MDL_INLINE float MDL::SkyCubeTexture::upperAtmosphereScattering() const {
  return Object::sendMessage<float>(
      this, _MDL_PRIVATE_SEL(upperAtmosphereScattering));
}
// write method: setUpperAtmosphereScattering:
_MDL_INLINE void MDL::SkyCubeTexture::setUpperAtmosphereScattering(
    float upperAtmosphereScattering) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setUpperAtmosphereScattering_),
...
_MDL_INLINE void MDL::SkyCubeTexture::setGroundAlbedo(float groundAlbedo) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setGroundAlbedo_),
                                   groundAlbedo);
}
...
_MDL_INLINE void
MDL::SkyCubeTexture::setHorizonElevation(float horizonElevation) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setHorizonElevation_),
                                   horizonElevation);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setGroundColor(CGColorRef groundColor) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setGroundColor_),
                                   groundColor);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setExposure(float exposure) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setExposure_),
                                   exposure);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setBrightness(float brightness) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setBrightness_),
                                   brightness);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setContrast(float contrast) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setContrast_),
                                   contrast);
}
...
_MDL_INLINE void MDL::SkyCubeTexture::setSaturation(float saturation) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSaturation_),
                                   saturation);
}

// property: highDynamicRangeCompression
_MDL_INLINE vector_float2
MDL::SkyCubeTexture::highDynamicRangeCompression() const {
  return Object::sendMessage<vector_float2>(
      this, _MDL_PRIVATE_SEL(highDynamicRangeCompression));
}
// write method: setHighDynamicRangeCompression:
_MDL_INLINE void MDL::SkyCubeTexture::setHighDynamicRangeCompression(
    vector_float2 highDynamicRangeCompression) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setHighDynamicRangeCompression_),
...
_MDL_INLINE MDL::ColorSwatchTexture *MDL::ColorSwatchTexture::alloc() {
  return NS::Object::alloc<MDL::ColorSwatchTexture>(
      _MDL_PRIVATE_CLS(MDLColorSwatchTexture));
}

// method:
// initWithColorTemperatureGradientFrom:toColorTemperature:name:textureDimensions:
_MDL_INLINE MDL::ColorSwatchTexture *
MDL::ColorSwatchTexture::initWithColorTemperatureGradientFrom(
    float colorTemperature1, float colorTemperature2, const NS::String *name,
    vector_int2 textureDimensions) {
  return Object::sendMessage<ColorSwatchTexture *>(
      this,
      _MDL_PRIVATE_SEL(
...
_MDL_INLINE MDL::ColorSwatchTexture *
MDL::ColorSwatchTexture::initWithColorGradientFrom(
    CGColorRef color1, CGColorRef color2, const NS::String *name,
    vector_int2 textureDimensions) {
  return Object::sendMessage<ColorSwatchTexture *>(
      this,
      _MDL_PRIVATE_SEL(
...
_MDL_INLINE MDL::ColorSwatchTexture *
MDL::ColorSwatchTexture::initWithColorGradientFrom(
    float color1, float color2, const NS::String *name,
    vector_int2 textureDimensions) {
  return Object::sendMessage<ColorSwatchTexture *>(
      this,
      _MDL_PRIVATE_SEL(
...
_MDL_INLINE MDL::NoiseTexture *MDL::NoiseTexture::alloc() {
  return NS::Object::alloc<MDL::NoiseTexture>(
      _MDL_PRIVATE_CLS(MDLNoiseTexture));
}

// method: initVectorNoiseWithSmoothness:name:textureDimensions:channelEncoding:
_MDL_INLINE MDL::NoiseTexture *MDL::NoiseTexture::initVectorNoiseWithSmoothness(
    float smoothness, const NS::String *name, vector_int2 textureDimensions,
    TextureChannelEncoding channelEncoding) {
  return Object::sendMessage<NoiseTexture *>(
      this,
      _MDL_PRIVATE_SEL(
...
// method:
// initScalarNoiseWithSmoothness:name:textureDimensions:channelCount:channelEncoding:grayscale:
_MDL_INLINE MDL::NoiseTexture *MDL::NoiseTexture::initScalarNoiseWithSmoothness(
    float smoothness, const NS::String *name, vector_int2 textureDimensions,
    int channelCount, TextureChannelEncoding channelEncoding, BOOL grayscale) {
  return Object::sendMessage<NoiseTexture *>(
      this,
      ...
      smoothness, name, textureDimensions, channelCount, channelEncoding,
      grayscale);
}

// method:
// initCellularNoiseWithFrequency:name:textureDimensions:channelEncoding:
_MDL_INLINE MDL::NoiseTexture *
MDL::NoiseTexture::initCellularNoiseWithFrequency(
    float frequency, const NS::String *name, vector_int2 textureDimensions,
    TextureChannelEncoding channelEncoding) {
  return Object::sendMessage<NoiseTexture *>(
      this,
      _MDL_PRIVATE_SEL(
...
_MDL_INLINE MDL::NormalMapTexture *MDL::NormalMapTexture::alloc() {
  return NS::Object::alloc<MDL::NormalMapTexture>(
      _MDL_PRIVATE_CLS(MDLNormalMapTexture));
}

// method: initByGeneratingNormalMapWithTexture:name:smoothness:contrast:
_MDL_INLINE MDL::NormalMapTexture *
MDL::NormalMapTexture::init(const Texture *sourceTexture,
                            const NS::String *name, float smoothness,
                            float contrast) {
  return Object::sendMessage<NormalMapTexture *>(
      this,
      _MDL_PRIVATE_SEL(
...
/**
 ...
 @discussion A texture optionally generates or loads texels
             ...
             properties, otherwise the texture object is a lightweight
 descriptor only.
...
//+ (nullable instancetype)textureNamed:(NSString *)name bundle:(nullable
// NSBundle*)bundleOrNil;
//+ (nullable instancetype)textureNamed:(NSString *)name
// assetResolver:(id<MDLAssetResolver>)resolver API_AVAILABLE(macos(10.14),
// ios(12.0), tvos(12.0));
...
/**
  ...
  @param names a collection of mosaiced images in a cross formation or column or
  row.
 ...
 */
//+ (nullable instancetype)textureCubeWithImagesNamed:(NSArray<NSString *>
//*)names;
//+ (nullable instancetype)textureCubeWithImagesNamed:(NSArray<NSString *>
//*)names
//                                             bundle:(nullable
...
//
///** write a particular level of a mipped texture to URL, deducing type from
/// path extension */
...
/** write a particular level of a mipped texture to URL, using a specific UT
 * type */
//- (BOOL)writeToURL:(NSURL *)nsurl type:(CFStringRef)type
// level:(NSUInteger)level API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0));
//
...
//
//- (nullable NSData *)texelDataWithTopLeftOriginAtMipLevel:(NSInteger)level
// create:(BOOL)create;
//- (nullable NSData *)texelDataWithBottomLeftOriginAtMipLevel:(NSInteger)level
// create:(BOOL)create;
...
/**
 hasAlphaValues
 @summary
 Can be overridden. If not overridden, hasAlpha will be NO if the texture does
 not have an alpha channel. It wil be YES if the texture has an alpha channel
 and there is at least one non-opaque texel in it.
 */
...
/**
 ...
 @discussion if any of the properties of the texture, such as data, are
 referenced, then the texture may be loaded, otherwise, the MDLURLTexture is
 merely a lightweight reference to something that could be loaded
 */
...
MDLSkyCubeTexture
 ...
 @property sunElevation A value of zero is at the zenith, 0.5 is at the horizon,
           1.0 is at the nadir. Use in conjunction with turbidity to give a
dawn, dusk, or noon look.
 @property turbidity A value of zero simulates the effect of a clear sky, the
sun will impart very little color to the sky. A value of one simulates a great
deal of dust and moisture in the sky, and will cause the sun's color to spread
across the atmosphere.
 @property upperAtmosphereScattering A value of zero will give very dusky
colors, a value of one will give noon-ish saturated colors.
 @property groundAlbedo controls the amount of light that bounces back up into
           ...
           value of one will reduce the contrast of the sky, making it a bit
foggy.

 @property horizonElevation If the lower half of the environment is being
replaced by a color, horizonElevation is angle, in radians, below which the
           replacement should occur. Negative values are below the horizon.

 @property groundColor If this value is set, the environment will be replaced
with the color below the horizonElevation value blended with the w factor up to
           Pi/2.0 past the horizon.
           (e.g. w = 0.0 groundColor is applied immediatly on the horizon with
no blend w = Pi/2 groundColor is linearly applied all the way to the south pole)
           NOTE: To maintain default behavior a simple length(groundColor) != 0
is used to determine if we want to set the ground color (e.g. black and blended
immediatly on the horizon use (0.0, 0.0, 0.0, 0.0000001)) 4 component treats the
first 3 components as color and w as blend factor 3 component treats the first 3
components as color and 0 as blend factor 2 component treats the first component
as greyscale color and y as blend factor 1 component treats the scalar component
as greyscale color and 0 as blend factor
 ...
 @property highDynamicRangeCompression values below the x component of this
value are not compressed during tone mapping. Values between the x component and
y component are compressed to the maximum brightness value during tone mapping.
Values above the limit are clamped.

 @discussion the texture will be created if data is referenced, otherwise, this
 object is merely a description. All parameters have legal values between zero
and one.
 */
...
//              channelEncoding:(MDLTextureChannelEncoding)channelEncoding
//            textureDimensions:(vector_int2)textureDimensions   // the size of
//            one cube face
//                    turbidity:(float)turbidity                 // the
//                    clearness of the sky
//                 sunElevation:(float)sunElevation              // from 0 to 1
//                 zenith to nadir
//    upperAtmosphereScattering:(float)upperAtmosphereScattering // how intense
//    the sun looks, 0 to 1
//                 groundAlbedo:(float)groundAlbedo;             // how much sky
//                 color is reflected from the Earth
//
//- (instancetype)initWithName:(nullable NSString*)name
//              channelEncoding:(MDLTextureChannelEncoding)channelEncoding
//            textureDimensions:(vector_int2)textureDimensions   // the size of
...
//                 sunElevation:(float)sunElevation              // from 0 to 1
//                 zenith to nadir
//                   sunAzimuth:(float)sunAzimuth                // from 0 to
//                   2Pi
//    upperAtmosphereScattering:(float)upperAtmosphereScattering // how intense
//    the sun looks, 0 to 1
//                 groundAlbedo:(float)groundAlbedo              // how much sky
...
//@property (nonatomic, assign) float sunAzimuth API_AVAILABLE(macos(10.13),
// ios(11.0), tvos(11.0));
...
//
///**
// Create a four channel texture containing directional noise. The RGBA values
// in this texture can be used as a normal map or as direction possibly with
// length. XYZ are a three dimensional direction, and A is a magnitude.
//
...
//
///**
// Create a texture containing colored noise. The noise texture is tileable with
// itself.
//
// @param smoothness how similar neighboring pixels are. A value of zero is like
//        static, one is smooth.
// @param grayscale if YES, RGB and A will all be the same. If no, RGB and A
// will
//        all be different. A is not pre-multiplied, because the intent is that
//        if you read a texel in a shader, all four values will be exactly the
//        same value if grayscale, or four different, uncorrelated values if not
//        grayscale.
// */
