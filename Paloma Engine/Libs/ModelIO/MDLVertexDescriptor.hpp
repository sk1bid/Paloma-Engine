...
_MDL_ENUM(NS::UInteger, VertexFormat){
    ...
    VertexFormatInt1010102Normalized = VertexFormatIntBits |
                                       VertexFormatPackedBit | 4,
    VertexFormatUInt1010102Normalized = VertexFormatUIntBits |
                                        VertexFormatPackedBit | 4};
...
public:
  ...
  MDL::VertexAttribute *init(const NS::String *name, const VertexFormat format,
                             const NS::UInteger offset,
                             const NS::UInteger bufferIndex);
...
_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeAnisotropy);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeBinormal);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeBitangent);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeColor);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeEdgeCrease);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeJointIndices);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeJointWeights);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeNormal);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeOcclusionValue);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributePosition);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeShadingBasisU);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeShadingBasisV);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeSubdivisionStencil);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeTangent);

_MDL_PRIVATE_DEF_STR(NS::String *, VertexAttributeTextureCoordinate);

//------------------------------------------------------------------------------

// static method: alloc
_MDL_INLINE MDL::VertexBufferLayout *MDL::VertexBufferLayout::alloc() {
  return NS::Object::alloc<MDL::VertexBufferLayout>(
      _MDL_PRIVATE_CLS(MDLVertexBufferLayout));
}

// method: initWithStride:stride:
_MDL_INLINE MDL::VertexBufferLayout *
MDL::VertexBufferLayout::init(const NS::UInteger stride) {
  return Object::sendMessage<MDL::VertexBufferLayout *>(
      this, _MDL_PRIVATE_SEL(initWithStride_stride_), stride);
}
...
_MDL_INLINE MDL::VertexAttribute *MDL::VertexAttribute::alloc() {
  return NS::Object::alloc<MDL::VertexAttribute>(
      _MDL_PRIVATE_CLS(MDLVertexAttribute));
}

// initWithName:format:offset:bufferIndex:
_MDL_INLINE MDL::VertexAttribute *
MDL::VertexAttribute::init(const NS::String *name, const VertexFormat format,
                           const NS::UInteger offset,
                           const NS::UInteger bufferIndex) {
  return Object::sendMessage<MDL::VertexAttribute *>(
      this, _MDL_PRIVATE_SEL(initWithName_format_offset_bufferIndex_), name,
      format, offset, bufferIndex);
}
...
_MDL_INLINE void
MDL::VertexAttribute::setFormat(const MDL::VertexFormat format) {
...
_MDL_INLINE NS::UInteger MDL::VertexAttribute::bufferIndex() const {
  return Object::sendMessage<NS::UInteger>(this, _MDL_PRIVATE_SEL(bufferIndex));
}
// write method: setBufferIndex:
_MDL_INLINE void
MDL::VertexAttribute::setBufferIndex(const NS::UInteger bufferIndex) {
  Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setBufferIndex_),
                            bufferIndex);
}
...
_MDL_INLINE vector_float4 MDL::VertexAttribute::initializationValue() const {
  return Object::sendMessage<vector_float4>(
      this, _MDL_PRIVATE_SEL(initializationValue));
}
// write method: setInitializationValue:
_MDL_INLINE void MDL::VertexAttribute::setInitializationValue(
    const vector_float4 initializationValue) {
  Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setInitializationValue_),
                            initializationValue);
}

// static method: alloc
_MDL_INLINE MDL::VertexDescriptor *MDL::VertexDescriptor::alloc() {
  return NS::Object::alloc<MDL::VertexDescriptor>(
      _MDL_PRIVATE_CLS(MDLVertexDescriptor));
}

// method: init
_MDL_INLINE MDL::VertexDescriptor *MDL::VertexDescriptor::init() {
  return NS::Object::init<MDL::VertexDescriptor>();
}

// initVertexDescriptor:
_MDL_INLINE MDL::VertexDescriptor *
MDL::VertexDescriptor::init(const MDL::VertexDescriptor *vertexDescriptor) {
  return Object::sendMessage<MDL::VertexDescriptor *>(
      this, _MDL_PRIVATE_SEL(initVertexDescriptor_), vertexDescriptor);
}

// method: attributeNamed:
_MDL_INLINE MDL::VertexAttribute *
MDL::VertexDescriptor::attributeNamed(const NS::String *name) {
  return Object::sendMessage<MDL::VertexAttribute *>(
      this, _MDL_PRIVATE_SEL(attributeNamed_), name);
}

// method: addOrReplaceAttribute:
_MDL_INLINE void MDL::VertexDescriptor::addOrReplaceAttribute(
    const MDL::VertexAttribute *attribute) {
  Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(addOrReplaceAttribute_),
                            attribute);
}

// method: removeAttributeNamed:
_MDL_INLINE void
MDL::VertexDescriptor::removeAttributeNamed(const NS::String *name) {
  Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(removeAttributeNamed_),
                            name);
}

// property: attributes
_MDL_INLINE NS::Array *MDL::VertexDescriptor::attributes() const {
  return Object::sendMessage<NS::Array *>(this, _MDL_PRIVATE_SEL(attributes));
}

// property: layouts
_MDL_INLINE NS::Array *MDL::VertexDescriptor::layouts() const {
  return Object::sendMessage<NS::Array *>(this, _MDL_PRIVATE_SEL(layouts));
}
...
//
///*! Indices of joints in an animation rig corresponding to weighting
/// information */
...
/*! A value indicating the degree to which a vertex is occluded by surrounding
 * geometry */
...
//
//     MDLVertexFormatUShortNormalized =  MDLVertexFormatUShortNormalizedBits |
//     1, MDLVertexFormatUShort2Normalized = MDLVertexFormatUShortNormalizedBits
//     | 2, MDLVertexFormatUShort3Normalized =
//     MDLVertexFormatUShortNormalizedBits | 3, MDLVertexFormatUShort4Normalized
//     = MDLVertexFormatUShortNormalizedBits | 4,
//
...
//
//     MDLVertexFormatInt1010102Normalized =  MDLVertexFormatIntBits  |
//     MDLVertexFormatPackedBit | 4, MDLVertexFormatUInt1010102Normalized =
//     MDLVertexFormatUIntBits | MDLVertexFormatPackedBit | 4
// };
...
//               buffer, the stride will be the sum of sizes of each attribute
//               (and any padding).
//             - If you store multiple attributes non-interleaved (back to
//             back),
//               the stride will be the size of an attribute (and all attributes
...
///*!
// @property name
// @abstract Identifying name of the attribute derived from model file, or one
// of
...
///*!
// @property offset
// @abstract offset in bytes of the attrbute in each element of the vertex
// buffer
// */
...
///*!
// @property initializationValue
// @abstract Value to initialize the attribute to in the vertex buffer if no
// values
...
/*!
 ...
 @discussion This object is a property of MDLMesh describing the current state
 of attributes and buffer layouts of the vertex buffers in the mesh. This must
 be immutable otherwise even small changes could cause the buffers to be out of
 sync with the layout described here.
...
// */
//-(instancetype) initWithVertexDescriptor:(MDLVertexDescriptor
//*)vertexDescriptor;
//
///*!
// @method attributeNamed:
// @abstract Retrieves the attribute with the given name
// @return The attribute with the supplied name or nil if attribute with the
// given
...
/*!
 @method addOrReplaceAttribute:
 @abstract Replace any attribute with the same name and time, or add it if it
...
// @discussion An array describing the current layout state of vertex buffers in
// an
//             MDLMesh mesh
// */
...
///*!
// @method setPackedStrides
// @abstract Sets the stride in each VertexBufferLout in the layouts array to
// the
