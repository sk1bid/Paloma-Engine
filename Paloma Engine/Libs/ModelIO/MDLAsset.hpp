...
#include "../metalcpp/Foundation/NSURL.hpp"
...
public:
  ...
  static class NS::Array *placeLightProbesWithDensity(
      float value, MDL::ProbePlacement type,
      const class LightProbeIrradianceDataSource *dataSource);
};

// Protocol
class LightProbeIrradianceDataSource
    : public NS::Referencing<LightProbeIrradianceDataSource> {
public:
  AxisAlignedBoundingBox boundingBox() const;
  ...
  static class NS::Array *placeLightProbesWithDensity(
      float value, const class LightProbeIrradianceDataSource *dataSource);
};
...
_MDL_INLINE MDL::Asset *MDL::Asset::init(const NS::URL *URL) {
  return Object::sendMessage<Asset *>(this, _MDL_PRIVATE_SEL(initWithURL_),
                                      URL);
}

// method: initWithURL:vertexDescriptor:bufferAllocator:
_MDL_INLINE MDL::Asset *
MDL::Asset::init(const NS::URL *URL, const VertexDescriptor *vertexDescriptor,
                 const class MeshBufferAllocator *bufferAllocator) {
  return Object::sendMessage<Asset *>(
      this, _MDL_PRIVATE_SEL(initWithURL_vertexDescriptor_bufferAllocator_),
      URL, vertexDescriptor, bufferAllocator);
}

// method: initWithBufferAllocator:
_MDL_INLINE MDL::Asset *
MDL::Asset::init(const class MeshBufferAllocator *bufferAllocator) {
  return Object::sendMessage<Asset *>(
...
_MDL_INLINE BOOL MDL::Asset::exportAssetToURL(const NS::URL *URL) {
  return Object::sendMessage<BOOL>(this, _MDL_PRIVATE_SEL(exportAssetToURL_),
                                   URL);
}
...
_MDL_INLINE BOOL MDL::Asset::exportAssetToURL(const NS::URL *URL,
  ...
  return Object::sendMessage<BOOL>(
      this, _MDL_PRIVATE_SEL(exportAssetToURL_error_), URL, error);
}

// method: objectAtPath:
_MDL_INLINE MDL::Object *MDL::Asset::objectAtPath(const NS::String *path) {
  return Object::sendMessage<MDL::Object *>(
      this, _MDL_PRIVATE_SEL(objectAtPath_), path);
}

// static method: canImportFileExtension:
_MDL_INLINE BOOL
MDL::Asset::canImportFileExtension(const NS::String *extention) {
  return Object::sendMessage<BOOL>(_MDL_PRIVATE_CLS(MDLAsset),
                                   _MDL_PRIVATE_SEL(canImportFileExtension_),
                                   extention);
}

// static method: canExportFileExtension:
_MDL_INLINE BOOL
MDL::Asset::canExportFileExtension(const NS::String *extention) {
  return Object::sendMessage<BOOL>(_MDL_PRIVATE_CLS(MDLAsset),
                                   _MDL_PRIVATE_SEL(canExportFileExtension_),
                                   extention);
}
...
_MDL_INLINE NS::Array *MDL::Asset::childObjectsOfClass(Class objectClass) {
  return Object::sendMessage<NS::Array *>(
      this, _MDL_PRIVATE_SEL(childObjectsOfClass_), objectClass);
}
...
_MDL_INLINE MDL::AxisAlignedBoundingBox
MDL::Asset::boundingBoxAtTime(NS::TimeInterval time) {
  return Object::sendMessage<AxisAlignedBoundingBox>(
      this, _MDL_PRIVATE_SEL(boundingBoxAtTime_), time);
}
...
_MDL_INLINE NS::TimeInterval MDL::Asset::startTime() const {
  return Object::sendMessage<NS::TimeInterval>(this,
                                               _MDL_PRIVATE_SEL(startTime));
}
// write method: setStartTime:
_MDL_INLINE void MDL::Asset::setStartTime(NS::TimeInterval startTime) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setStartTime_),
                                   startTime);
}
...
_MDL_INLINE void MDL::Asset::setEndTime(NS::TimeInterval endTime) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setEndTime_),
                                   endTime);
}
...
_MDL_INLINE void MDL::Asset::setResolver(const class AssetResolver *resolver) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setResolver_),
                                   resolver);
}
...
_MDL_INLINE MDL::MeshBufferAllocator *MDL::Asset::bufferAllocator() const {
  return Object::sendMessage<MeshBufferAllocator *>(
      this, _MDL_PRIVATE_SEL(bufferAllocator));
}
...
_MDL_INLINE void MDL::Asset::removeObject(const MDL::Object *object) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(removeObject_),
                                   object);
}
...
_MDL_INLINE MDL::Object *
MDL::Asset::objectAtIndexedSubscript(NS::UInteger index) {
  return Object::sendMessage<MDL::Object *>(
      this, _MDL_PRIVATE_SEL(objectAtIndexedSubscript_), index);
}

// method: objectAtIndex:
_MDL_INLINE MDL::Object *MDL::Asset::objectAtIndex(NS::UInteger index) {
  return Object::sendMessage<MDL::Object *>(
      this, _MDL_PRIVATE_SEL(objectAtIndex_), index);
}

// property: masters
_MDL_INLINE MDL::ObjectContainerComponent *MDL::Asset::masters() const {
  return Object::sendMessage<ObjectContainerComponent *>(
      this, _MDL_PRIVATE_SEL(masters));
}
// write method: setMasters:
_MDL_INLINE void
MDL::Asset::setMasters(const class ObjectContainerComponent *masters) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMasters_),
                                   masters);
}
...
_MDL_INLINE MDL::ObjectContainerComponent *MDL::Asset::originals() const {
  return Object::sendMessage<ObjectContainerComponent *>(
      this, _MDL_PRIVATE_SEL(originals));
}
// write method: setOriginals:
_MDL_INLINE void
MDL::Asset::setOriginals(const class ObjectContainerComponent *originals) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setOriginals_),
                                   originals);
}
...
_MDL_INLINE MDL::ObjectContainerComponent *MDL::Asset::animations() const {
  return Object::sendMessage<ObjectContainerComponent *>(
      this, _MDL_PRIVATE_SEL(animations));
}
// write method: setAnimations:
_MDL_INLINE void
MDL::Asset::setAnimations(const class ObjectContainerComponent *animations) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setAnimations_),
                                   animations);
}
...
// property: boundingBox
_MDL_INLINE MDL::AxisAlignedBoundingBox
MDL::LightProbeIrradianceDataSource::boundingBox() const {
  return Object::sendMessage<AxisAlignedBoundingBox>(
      this, _MDL_PRIVATE_SEL(boundingBox));
}
// write method: setBoundingBox:
_MDL_INLINE void MDL::LightProbeIrradianceDataSource::setBoundingBox(
    AxisAlignedBoundingBox boundingBox) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setBoundingBox_),
                                   boundingBox);
}

// property: sphericalHarmonicsLevel
_MDL_INLINE NS::UInteger
MDL::LightProbeIrradianceDataSource::sphericalHarmonicsLevel() const {
  return Object::sendMessage<NS::UInteger>(
      this, _MDL_PRIVATE_SEL(sphericalHarmonicsLevel));
}
// write method: setSphericalHarmonicsLevel:
_MDL_INLINE void
MDL::LightProbeIrradianceDataSource::setSphericalHarmonicsLevel(
    NS::UInteger sphericalHarmonicsLevel) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setSphericalHarmonicsLevel_),
      sphericalHarmonicsLevel);
}

// method: sphericalHarmonicsCoefficientsAtPosition:
_MDL_INLINE NS::Data *
MDL::LightProbeIrradianceDataSource::sphericalHarmonicsCoefficientsAtPosition(
    vector_float3 position) {
  return Object::sendMessage<NS::Data *>(
      this, _MDL_PRIVATE_SEL(sphericalHarmonicsCoefficientsAtPosition_),
      position);
}

// static method:
// placeLightProbesWithDensity:heuristic:usingIrradianceDataSource:
_MDL_INLINE NS::Array *MDL::Asset::placeLightProbesWithDensity(
    float value, MDL::ProbePlacement type,
    const class LightProbeIrradianceDataSource *dataSource) {
  return Object::sendMessage<NS::Array *>(
      _MDL_PRIVATE_CLS(MDLAsset),
      _MDL_PRIVATE_SEL(
...
//////
////// @discussion Each asset contains a collection of hierarchies of objects,
/// where
//////             each object in the asset is the top level of a hierarchy.
/// Objects
//////             include transforms, lights, cameras, and meshes.
//////
////// MDLAssets are typically instantiated from NSURLs that refer to a model
/// resource.
//////
////// The model resource may represented timed information, for example, a
/// series of
////// mesh morphs. If the asset is timed, then the framerate will be non-zero,
/// and the
////// firstFrame and lastFrame properties will indicate the range for which
/// sample
////// data exists. Samples before or after that range will be clamped. Some
/// model
////// resource representations allow continuous sampling, others are discrete.
/// In the
////// discrete case, if a requested sample time is not on a discrete boundary
/// the
////// returned sample will be the sample exactly on the sample time, or if no
/// such is
////// available, the immediately preceding sample. If no time is specified for
/// a
////// sample, the first data will be returned.
//////
////// An asset's bounding box can be queried without traversing the hierarchy
/// of
////// objects.
//////
////// Fast enumeration of an MDLAsset iterates the top level objects contained
/// within.
////// */
//////
//////
...
///////*!
////// @method initWithURL:
////// @abstract Initialize an MDLAsset using the contents of the resource
/// located at
//////           the indicated URL
////// @discussion Vertex layout (i.e. vertexDescriptor) will be specified by
/// ModelIO
//////             depending on attributes of the resource.  Buffers will be
/// allocated
...
////// @abstract Initialize an MDLAsset using the contents of the resource
/// located at
//////           URL, ensuring that the asset conforms to the supplied
/// vertexDescriptor,
//////           and buffers are allocated in the supplied allocator
//////
////// @discussion The default behavior is to triangulate any discovered meshes
/// and to
//////             conform the mesh to the supplied vertexDescriptor.
//////
//////             If nil is passed as the vertexDescriptor, then a
/// vertexDescriptor
//////             will be created according to the attributes of the resource.
//////
//////             If nil is passed as the bufferAllocator, buffers will be
/// allocated
//////             using a default NSData based allocator.
//////
//////             Submeshes will be converted to triangle topology.
...
//////           vertexDescriptor:(nullable
/// MDLVertexDescriptor*)vertexDescriptor
//////            bufferAllocator:(nullable
/// id<MDLMeshBufferAllocator>)bufferAllocator;
//////
///////*!
////// @method initWithBufferAllocator:
////// @abstract Initialize an empty MDLAsset with a buffer allocator to be used
/// during
//////           other operations.
////// */
...
////// @method
/// initWithURL:vertexDescriptor:bufferAllocator:preserveTopology:error:
////// @abstract Same as initWithURL:vertexDescriptor:bufferAllocator: except
/// that
//////           if preserveTopology is YES, a topology buffer might be created
/// on the
//////           submeshes.
//////
////// @discussion If all faces in a submesh have the same vertex count, then
/// the
//////             submesh will a geometry type corresponding to that vertex
/// count.
//////             For example, if all faces have four vertices, then the
/// geometry
//////             type will be MDLGeometryTypeQuads. If faces have a varying
/// number
//////             of vertices, then the the submesh type will be
//////             MDLGeometryTypeVariableTopology, and a faceTopologyBuffer
/// will be
//////             created.
////// */
//////- (instancetype)initWithURL:(NSURL *)URL
...
////// */
//////- (BOOL)exportAssetToURL:(NSURL *)URL NS_SWIFT_UNAVAILABLE("Use
/// exportAssetToURL:error");
////
/////*!
//// @method exportAssetToURL:error:
...
//// @return YES is returned if exporting proceeded successfully,
//// */
////- (BOOL)exportAssetToURL:(NSURL *)URL error:(NSError * __nullable *
///__nullable)error;
////
/////*!
//// @abstract Return the object at the specified path, or nil if none exists
/// there / */
////- (MDLObject*)objectAtPath:(NSString*)path API_AVAILABLE(macos(10.13),
/// ios(11.0), tvos(11.0));
////
/////*!
//// @method canImportFileExtension:
//// @abstract Indicates whether MDLAsset object can be initialized with
/// resource /           with the given extension / @return YES is returned if
/// MDLAsset is able to load and represent assets with /           the given
/// extension / */
////+ (BOOL)canImportFileExtension:(NSString *)extension;
////
/////*!
//// @method canImportFileExtension:
//// @abstract Indicates whether MDLAsset object can export asset to resource
/// with /           the given extension / @return YES is returned if MDLAsset
/// is able is able to export assets to /         resources with the given
/// extension / */
////+ (BOOL)canExportFileExtension:(NSString *)extension;
////
/////*!
//// @method childObjectsOfClass:
//// @abstract Inspects an asset's hierarchy for objects of the specified class
/// type / @return returns an NSArray of all objects in the asset matching the
/// requested class / @discussion This can be used to get references to all
/// MDLMesh objects, MDLLights, /             etc. if objectClass is not a
/// subclass of MDLObject, an exception will be /             raised. / */
////- (NSArray<MDLObject*>*)childObjectsOfClass:(Class)objectClass;
////
/////*!
//// @method loadTextures
//// @abstract Iterates over all material properties on all materials. If they
/// are string /           values or NSURL values, and can be resolved as
/// textures, then the string /           and NSURL values will be replaced by
/// MDLTextureSampler values. / */
...
// @discussion If no framerate was specified by resource or resource uncapable
// of
...
// @discussion If no animation data was specified by resource or resource
// incapable
//             of specifying animation data, this value defaults to 0. If
//             startTime was set explicitly, then the value of startTime will be
//             the lesser of the set value and the animated values.
// */
...
// @discussion Some imported formats specify a scene up axis. By default Y-axis
// (0, 1, 0) is used but other values are supported.
// */
...
// */
//@property (nonatomic, readonly, retain, nullable) MDLVertexDescriptor
//*vertexDescriptor;
//
///*!
// @method addObject:
...
// API_DEPRECATED_WITH_REPLACEMENT("originals", ios(10.0,15.0), tvos(10.0,15.0),
// macos(10.12,12.0));
//
///*!
// @property originals
// @abstract Original objects that can be instanced into the asset's object
// hierarchy
...
///*!
// @property animations
// @abstract Animations that can be bound to MDLObjects (@see
...
//@optional
///**
// Spherical harmonics level used to calculate the spherical harmonics
// coefficients.
// */
//@property NSUInteger sphericalHarmonicsLevel;
//
///**
// Given a position in the source scene, returns the spherical harmonics
// coefficients at that point.
//
// The data returned is an array of 32-bit floating-point values, containing
// three non-interleaved data sets corresponding to the red, green, and blue
// sets of coefficients. The array’s length is determined by the
// sphericalHarmonicsLevel property.
// */
//-(NSData *)sphericalHarmonicsCoefficientsAtPosition:(vector_float3)position;
//@end

/**
 Given a light probe density, method places light probes in the scene according
 to the passed in placement heuristic type. The higher the density, the greater
 the number of light probes placed in the scene.

 Using the placement heuristic MDLProbePlacementUniformGrid places the light
 probes in the scene as a uniform grid. The placement heuristic
 MDLProbePlacementIrradianceDistribution places the light probes in areas of
 greatest irradiance change.
 */
//@interface MDLAsset (MDLLightBaking)
//+ (NSArray<MDLLightProbe *> *)placeLightProbesWithDensity:(float)value
// heuristic:(MDLProbePlacement)type
