...
_MDL_EXTERN NS::String *const kUTTypeAlembic;
_MDL_EXTERN NS::String *const kUTType3dObject;
_MDL_EXTERN NS::String *const kUTTypePolygon;
_MDL_EXTERN NS::String *const kUTTypeStereolithography;
_MDL_EXTERN NS::String *const kUTTypeUniversalSceneDescription;
_MDL_EXTERN NS::String *const kUTTypeUniversalSceneDescriptionMobile;

// TODO: NS_ASSUME_NONNULL_BEGIN
_MDL_ENUM(NS::UInteger, IndexBitDepth){
    IndexBitDepthInvalid = 0, IndexBitDepthUInt8 = 8,
    IndexBitDepthUint8 = 8,   IndexBitDepthUInt16 = 16,
    IndexBitDepthUint16 = 16, IndexBitDepthUInt32 = 32,
    IndexBitDepthUint32 = 32,
};

_MDL_ENUM(NS::Integer,
          GeometryType){GeometryTypePoints = 0, GeometryTypeLines,
                        GeometryTypeTriangles,  GeometryTypeTriangleStrips,
                        GeometryTypeQuads,      GeometryTypeVariableTopology};

_MDL_ENUM(NS::Integer, ProbePlacement){ProbePlacementUniformGrid = 0,
                                       ProbePlacementIrradianceDistribution};

_MDL_ENUM(NS::UInteger, DataPrecision){DataPrecisionUndefined,
                                       DataPrecisionFloat, DataPrecisionDouble};
...
public:
  ...
  void setParent(const MDL::Object *parent);

  class Object *instance() const;
  void setInstance(const MDL::Object *instance);
  ...
  void enumerateChildObjectsOfClass(
...
class ObjectContainerComponent
    : public NS::Referencing<MDL::Component, NS::FastEnumeration> {
public:
  // addObject:
...
// method: addObject:
_MDL_INLINE void
MDL::ObjectContainerComponent::addObject(const MDL::Object *object) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(addObject_), object);
}

// method: addObject:
_MDL_INLINE void
MDL::ObjectContainerComponent::removeObject(const MDL::Object *object) {
...
MDL::ObjectContainerComponent::objectAtIndexedSubscript(
    const NS::UInteger index) {
...
// MDL_EXPORT NSString * __nonnull const kUTTypeAlembic
// API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0));
//
///* 3d Object file format, file extension OBJ, UTI
/// public.geometry-definition-format */
// MDL_EXPORT NSString * __nonnull const kUTType3dObject
// API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0));
//
///* Polygon file format, file extension PLY, UTI public.polygon-file-format */
// MDL_EXPORT NSString * __nonnull const kUTTypePolygon
// API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0));
//
///* Stereolithography file format, file extension STL, UTI
/// public.standard-tesselated-geometry-format */
// MDL_EXPORT NSString * __nonnull const kUTTypeStereolithography
// API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0));
//
///* Universal Scene Description file format, file extension USDA or USDC, UTI
/// com.pixar.universal-scene-description */
// MDL_EXPORT NSString * __nonnull const kUTTypeUniversalSceneDescription
// API_AVAILABLE(macos(10.12), ios(10.0), tvos(9.0));
//
///* Universal Scene Description Mobile file format, file extension USDZ, UTI
/// com.pixar.universal-scene-description-mobile */
// MDL_EXPORT NSString * __nonnull const kUTTypeUniversalSceneDescriptionMobile
...
// API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0));
//
//@property (readonly) NSUInteger count API_AVAILABLE(macos(10.13), ios(11.0),
// tvos(11.0));
//
