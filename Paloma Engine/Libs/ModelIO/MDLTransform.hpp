...
class TransformComponent
    : public NS::Copying<TransformComponent, MDL::Component> {
public:
  // assign
  ...
  static matrix_float4x4 globalTransformWithObject(const MDL::Object *object,
...
_MDL_INLINE void
MDL::TransformComponent::setResetsTransform(BOOL resetsTransform) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setResetsTransform_),
                                   resetsTransform);
}
...
_MDL_INLINE void
MDL::TransformComponent::setLocalTransform(matrix_float4x4 transform,
                                           NS::TimeInterval time) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setLocalTransform_forTime_), transform, time);
}

// method: setLocalTransform:
_MDL_INLINE void
MDL::TransformComponent::setLocalTransform(matrix_float4x4 transform) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setLocalTransform_),
                                   transform);
}

// method: localTransformAtTime:
_MDL_INLINE matrix_float4x4
MDL::TransformComponent::localTransformAtTime(NS::TimeInterval time) {
  return Object::sendMessage<matrix_float4x4>(
      this, _MDL_PRIVATE_SEL(localTransformAtTime_), time);
}

// method: globalTransformWithObject:atTime:
_MDL_INLINE matrix_float4x4 MDL::TransformComponent::globalTransformWithObject(
    const MDL::Object *object, NS::TimeInterval time) {
  return Object::sendMessage<matrix_float4x4>(
      _MDL_PRIVATE_CLS(MDLTransform),
      _MDL_PRIVATE_SEL(globalTransformWithObject_atTime_), object, time);
}
...
_MDL_INLINE MDL::Transform *
MDL::Transform::init(const TransformComponent *component) {
  return Object::sendMessage<MDL::Transform *>(
      this, _MDL_PRIVATE_SEL(initWithTransformComponent_), component);
}
...
MDL::Transform::init(const TransformComponent *component,
                     BOOL resetsTransform) {
  return Object::sendMessage<MDL::Transform *>(
      this, _MDL_PRIVATE_SEL(initWithTransformComponent_resetsTransform_),
      component, resetsTransform);
}

// method: initWithMatrix:
_MDL_INLINE MDL::Transform *MDL::Transform::init(matrix_float4x4 matrix) {
  return Object::sendMessage<MDL::Transform *>(
      this, _MDL_PRIVATE_SEL(initWithMatrix_), matrix);
}
...
_MDL_INLINE MDL::Transform *MDL::Transform::init(matrix_float4x4 matrix,
                                                 BOOL resetsTransform) {
  return Object::sendMessage<MDL::Transform *>(
      this, _MDL_PRIVATE_SEL(initWithMatrix_resetsTransform_), matrix,
      resetsTransform);
}
...
MDL::Transform::translationAtTime(NS::TimeInterval time) {
  return Object::sendMessage<vector_float3>(
      this, _MDL_PRIVATE_SEL(translationAtTime_), time);
}

// method: rotationAtTime:
_MDL_INLINE vector_float3
MDL::Transform::rotationAtTime(NS::TimeInterval time) {
  return Object::sendMessage<vector_float3>(
      this, _MDL_PRIVATE_SEL(rotationAtTime_), time);
}

// method: shearAtTime:
_MDL_INLINE vector_float3 MDL::Transform::shearAtTime(NS::TimeInterval time) {
  return Object::sendMessage<vector_float3>(
      this, _MDL_PRIVATE_SEL(shearAtTime_), time);
}

// method: scaleAtTime:
_MDL_INLINE vector_float3 MDL::Transform::scaleAtTime(NS::TimeInterval time) {
  return Object::sendMessage<vector_float3>(
      this, _MDL_PRIVATE_SEL(scaleAtTime_), time);
}

// method: setMatrix:forTime:
_MDL_INLINE void MDL::Transform::setMatrix(matrix_float4x4 matrix,
                                           NS::TimeInterval time) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMatrix_forTime_),
                                   matrix, time);
}
...
_MDL_INLINE void MDL::Transform::setTranslation(vector_float3 translation,
                                                NS::TimeInterval time) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setTranslation_forTime_), translation, time);
}

// method: setRotation:forTime:
_MDL_INLINE void MDL::Transform::setRotation(vector_float3 rotation,
                                             NS::TimeInterval time) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setRotation_forTime_),
                                   rotation, time);
}
...
_MDL_INLINE void MDL::Transform::setShear(vector_float3 shear,
                                          NS::TimeInterval time) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setShear_forTime_),
                                   shear, time);
}
...
_MDL_INLINE void MDL::Transform::setScale(vector_float3 scale,
                                          NS::TimeInterval time) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setScale_forTime_),
                                   scale, time);
}

// method: rotationMatrixAtTime:
_MDL_INLINE matrix_float4x4
MDL::Transform::rotationMatrixAtTime(NS::TimeInterval time) {
  return Object::sendMessage<matrix_float4x4>(
      this, _MDL_PRIVATE_SEL(rotationMatrixAtTime_), time);
}

// property: translation
_MDL_INLINE vector_float3 MDL::Transform::translation() const {
  return Object::sendMessage<vector_float3>(this,
                                            _MDL_PRIVATE_SEL(translation));
}
// write method: setTranslation:
_MDL_INLINE void MDL::Transform::setTranslation(vector_float3 translation) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setTranslation_),
                                   translation);
}
...
_MDL_INLINE void MDL::Transform::setRotation(vector_float3 rotation) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setRotation_),
                                   rotation);
}
...
/** An array of sample times for which a key has been stored
    If no animation data is present, the array will contain a single value of
   zero */
...
//
///** Returns the transform governing this transformable at the specified frame
/// in
//    world space. If there is no parent, identity will be returned
// */
//+ (matrix_float4x4)globalTransformWithObject:(MDLObject *)object
...
//- (instancetype)initWithIdentity API_DEPRECATED_WITH_REPLACEMENT("init",
// macos(10.11, 10.13), ios(9.0, 11.0), tvos(9.0, 11.0));
//-
...
//
///**
// If these properties are read and animation data exists the earliest value is
// returned. Otherwise, if there is no animation data, the value of the property
// is the same at all times and that value is returned. If written, timing
// information for said property is removed. To retain or add timing
// information, use the set:forTime selectors instead.
// */
