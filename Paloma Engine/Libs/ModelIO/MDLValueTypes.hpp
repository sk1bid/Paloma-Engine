...
public:
  ...
  void setDouble4x4Array(const matrix_double4x4 *valuesArray,
                         NS::UInteger count);
...
_MDL_INLINE MDL::Matrix4x4Array *MDL::Matrix4x4Array::alloc() {
  return NS::Object::alloc<MDL::Matrix4x4Array>(
      _MDL_PRIVATE_CLS(MDLMatrix4x4Array));
}
...
_MDL_INLINE MDL::Matrix4x4Array *
MDL::Matrix4x4Array::init(const NS::UInteger arrayElementCount) {
  return Object::sendMessage<MDL::Matrix4x4Array *>(
...
_MDL_INLINE MDL::DataPrecision MDL::Matrix4x4Array::precision() const {
  return Object::sendMessage<MDL::DataPrecision>(this,
                                                 _MDL_PRIVATE_SEL(precision));
}
...
_MDL_INLINE void
MDL::Matrix4x4Array::setFloat4x4Array(const matrix_float4x4 *valuesArray,
                                      NS::UInteger count) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setFloat4x4Array_count_), valuesArray, count);
}

// method: setDouble4x4Array:count:
_MDL_INLINE void
MDL::Matrix4x4Array::setDouble4x4Array(const matrix_double4x4 *valuesArray,
                                       NS::UInteger count) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setDouble4x4Array_count_), valuesArray, count);
}

// method: getFloat4x4Array:maxCount:
_MDL_INLINE NS::UInteger
MDL::Matrix4x4Array::getFloat4x4Array(const matrix_float4x4 *valuesArray,
                                      NS::UInteger maxCount) {
  return Object::sendMessage<NS::UInteger>(
      this, _MDL_PRIVATE_SEL(getFloat4x4Array_maxCount_), valuesArray,
      maxCount);
}

// method: getDouble4x4Array:maxCount:
_MDL_INLINE NS::UInteger
MDL::Matrix4x4Array::getDouble4x4Array(const matrix_double4x4 *valuesArray,
                                       NS::UInteger maxCount) {
  return Object::sendMessage<NS::UInteger>(
      this, _MDL_PRIVATE_SEL(getDouble4x4Array_maxCount_), valuesArray,
      maxCount);
}
...
//
//-(void)setFloat4x4Array:(const matrix_float4x4 *)valuesArray
// count:(NSUInteger)count NS_REFINED_FOR_SWIFT;
//-(void)setDouble4x4Array:(const matrix_double4x4 *)valuesArray
// count:(NSUInteger)count NS_REFINED_FOR_SWIFT;
//
