...
public:
  ...
  // initWithName:jointPaths:
  class PackedJointAnimation *init(const NS::String *name,
                                   const NS::Array *jointPaths);
};
...
_MDL_INLINE MDL::Matrix4x4Array *MDL::Skeleton::jointBindTransforms() const {
  return Object::sendMessage<Matrix4x4Array *>(
      this, _MDL_PRIVATE_SEL(jointBindTransforms));
}

// property: jointRestTransforms
_MDL_INLINE MDL::Matrix4x4Array *MDL::Skeleton::jointRestTransforms() const {
  return Object::sendMessage<Matrix4x4Array *>(
      this, _MDL_PRIVATE_SEL(jointRestTransforms));
}

// method: initWithName:jointPaths:
_MDL_INLINE MDL::Skeleton *MDL::Skeleton::init(const NS::String *name,
                                               const NS::Array *jointPaths) {
  return Object::sendMessage<MDL::Skeleton *>(
      this, _MDL_PRIVATE_SEL(initWithName_jointPaths_), name, jointPaths);
}
...
_MDL_INLINE MDL::PackedJointAnimation *MDL::PackedJointAnimation::alloc() {
  return NS::Object::alloc<MDL::PackedJointAnimation>(
      _MDL_PRIVATE_CLS(MDLPackedJointAnimation));
}
...
MDL::PackedJointAnimation::translations() const {
  return Object::sendMessage<AnimatedVector3Array *>(
      this, _MDL_PRIVATE_SEL(translations));
}

// property: rotations
_MDL_INLINE MDL::AnimatedQuaternionArray *
MDL::PackedJointAnimation::rotations() const {
  return Object::sendMessage<AnimatedQuaternionArray *>(
      this, _MDL_PRIVATE_SEL(rotations));
}

// property: scales
_MDL_INLINE MDL::AnimatedVector3Array *
MDL::PackedJointAnimation::scales() const {
  return Object::sendMessage<AnimatedVector3Array *>(this,
                                                     _MDL_PRIVATE_SEL(scales));
}

// method: initWithName:jointPaths:
_MDL_INLINE MDL::PackedJointAnimation *
MDL::PackedJointAnimation::init(const NS::String *name,
                                const NS::Array *jointPaths) {
  return Object::sendMessage<MDL::PackedJointAnimation *>(
      this, _MDL_PRIVATE_SEL(initWithName_jointPaths_), name, jointPaths);
}
...
_MDL_INLINE MDL::AnimationBindComponent *MDL::AnimationBindComponent::alloc() {
  return NS::Object::alloc<MDL::AnimationBindComponent>(
      _MDL_PRIVATE_CLS(MDLAnimationBindComponent));
}
...
_MDL_INLINE void
MDL::AnimationBindComponent::setSkeleton(const Skeleton *skeleton) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSkeleton_),
                                   skeleton);
}

// property: jointAnimation
_MDL_INLINE MDL::JointAnimation *
MDL::AnimationBindComponent::jointAnimation() const {
  return Object::sendMessage<JointAnimation *>(
      this, _MDL_PRIVATE_SEL(jointAnimation));
}
// write method: setJointAnimation:
_MDL_INLINE void MDL::AnimationBindComponent::setJointAnimation(
    const JointAnimation *jointAnimation) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setJointAnimation_),
                                   jointAnimation);
}
...
_MDL_INLINE void
MDL::AnimationBindComponent::setJointPaths(const NS::Array *jointPaths) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setJointPaths_),
                                   jointPaths);
}

// property: geometryBindTransform
_MDL_INLINE matrix_double4x4
MDL::AnimationBindComponent::geometryBindTransform() const {
  return Object::sendMessage<matrix_double4x4>(
      this, _MDL_PRIVATE_SEL(geometryBindTransform));
}
// write method: setGeometryBindTransform:
_MDL_INLINE void MDL::AnimationBindComponent::setGeometryBindTransform(
    matrix_double4x4 geometryBindTransform) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setGeometryBindTransform_), geometryBindTransform);
}
...
//
//  // local space default transforms, used for joints not animated in a
...
//
//  // optional. If set, jointIndices vertex buffers index into this list of
//  joints.
