...
class MaterialPropertyNode;
class MaterialPropertyConnection;
class MaterialPropertyGraph;
class ScatteringFunction;
class PhysicallyPlausibleScatteringFunction;
class Material;
} // namespace MDL

namespace MDL {
_MDL_ENUM(NS::UInteger,
          MaterialSemantic){MaterialSemanticBaseColor = 0,
...
_MDL_ENUM(NS::UInteger, MaterialPropertyType){
    MaterialPropertyTypeNone = 0, // default resulting from [MaterialProperty
                                  // init]
    MaterialPropertyTypeString, MaterialPropertyTypeURL,
    MaterialPropertyTypeTexture, MaterialPropertyTypeColor,
    MaterialPropertyTypeFloat, MaterialPropertyTypeFloat2,
    MaterialPropertyTypeFloat3, MaterialPropertyTypeFloat4,
    MaterialPropertyTypeMatrix44, MaterialPropertyTypeBuffer};
...
public:
  ...
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic);

  // initWithName:semantic:float2:
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic, vector_float2 value);

  // initWithName:semantic:float3:
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic, vector_float3 value);

  // initWithName:semantic:float:
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic, float value);

  // initWithName:semantic:float4:
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic, vector_float4 value);
  ...
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic, const NS::URL *URL);
  ...
  class MaterialProperty *init(const NS::String *name,
                               MaterialSemantic semantic, CGColorRef color);
...
public:
  ...
  class MaterialPropertyNode *
  init(const class MaterialProperty *inputs,
       // !!!: Uncertain
...
class PhysicallyPlausibleScatteringFunction
    : public NS::Copying<ScatteringFunction> {
public:
...
_MDL_ENUM(NS::UInteger, MaterialFace){MaterialFaceFront = 0, MaterialFaceBack,
...
public:
  ...
  class Material *init(const NS::String *name,
                       const ScatteringFunction *scatteringFunction);
...
_MDL_INLINE MDL::TextureFilter *MDL::TextureFilter::alloc() {
  return NS::Object::alloc<MDL::TextureFilter>(
      _MDL_PRIVATE_CLS(MDLTextureFilter));
}
...
_MDL_INLINE MDL::MaterialTextureWrapMode MDL::TextureFilter::sWrapMode() const {
  return Object::sendMessage<MaterialTextureWrapMode>(
      this, _MDL_PRIVATE_SEL(sWrapMode));
}
// write method: setSWrapMode:
_MDL_INLINE void
MDL::TextureFilter::setSWrapMode(MaterialTextureWrapMode sWrapMode) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSWrapMode_),
                                   sWrapMode);
}
...
_MDL_INLINE MDL::MaterialTextureWrapMode MDL::TextureFilter::tWrapMode() const {
  return Object::sendMessage<MaterialTextureWrapMode>(
      this, _MDL_PRIVATE_SEL(tWrapMode));
}
// write method: setTWrapMode:
_MDL_INLINE void
MDL::TextureFilter::setTWrapMode(MaterialTextureWrapMode tWrapMode) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setTWrapMode_),
                                   tWrapMode);
}
...
_MDL_INLINE MDL::MaterialTextureWrapMode MDL::TextureFilter::rWrapMode() const {
  return Object::sendMessage<MaterialTextureWrapMode>(
      this, _MDL_PRIVATE_SEL(rWrapMode));
}
// write method: setRWrapMode:
_MDL_INLINE void
MDL::TextureFilter::setRWrapMode(MaterialTextureWrapMode rWrapMode) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setRWrapMode_),
                                   rWrapMode);
}

// property: minFilter
_MDL_INLINE MDL::MaterialTextureFilterMode
MDL::TextureFilter::minFilter() const {
  return Object::sendMessage<MaterialTextureFilterMode>(
      this, _MDL_PRIVATE_SEL(minFilter));
}
// write method: setMinFilter:
_MDL_INLINE void
MDL::TextureFilter::setMinFilter(MaterialTextureFilterMode minFilter) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMinFilter_),
                                   minFilter);
}

// property: magFilter
_MDL_INLINE MDL::MaterialTextureFilterMode
MDL::TextureFilter::magFilter() const {
  return Object::sendMessage<MaterialTextureFilterMode>(
      this, _MDL_PRIVATE_SEL(magFilter));
}
// write method: setMagFilter:
_MDL_INLINE void
MDL::TextureFilter::setMagFilter(MaterialTextureFilterMode magFilter) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMagFilter_),
                                   magFilter);
}

// property: mipFilter
_MDL_INLINE MDL::MaterialMipMapFilterMode
MDL::TextureFilter::mipFilter() const {
  return Object::sendMessage<MaterialMipMapFilterMode>(
      this, _MDL_PRIVATE_SEL(mipFilter));
}
// write method: setMipFilter:
_MDL_INLINE void
MDL::TextureFilter::setMipFilter(MaterialMipMapFilterMode mipFilter) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMipFilter_),
                                   mipFilter);
}
...
_MDL_INLINE MDL::TextureSampler *MDL::TextureSampler::alloc() {
  return NS::Object::alloc<MDL::TextureSampler>(
      _MDL_PRIVATE_CLS(MDLTextureSampler));
}
...
_MDL_INLINE void MDL::TextureSampler::setTexture(const Texture *texture) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setTexture_),
                                   texture);
}

// property: hardwareFilter
_MDL_INLINE MDL::TextureFilter *MDL::TextureSampler::hardwareFilter() const {
  return Object::sendMessage<TextureFilter *>(this,
                                              _MDL_PRIVATE_SEL(hardwareFilter));
}
// write method: setHardwareFilter:
_MDL_INLINE void
MDL::TextureSampler::setHardwareFilter(const TextureFilter *hardwareFilter) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setHardwareFilter_),
                                   hardwareFilter);
}
...
_MDL_INLINE void MDL::TextureSampler::setTransform(const Transform *transform) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setTransform_),
                                   transform);
}
...
_MDL_INLINE MDL::MaterialProperty *MDL::MaterialProperty::alloc() {
  return NS::Object::alloc<MDL::MaterialProperty>(
      _MDL_PRIVATE_CLS(MDLMaterialProperty));
}

// method: initWithName:semantic:
_MDL_INLINE MDL::MaterialProperty *
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_), name, semantic);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            vector_float2 value) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_float2_), name, semantic,
      value);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            vector_float3 value) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_float3_), name, semantic,
      value);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            float value) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_float_), name, semantic,
      value);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            vector_float4 value) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_float4_), name, semantic,
      value);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            matrix_float4x4 value) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_matrix4x4_), name, semantic,
      value);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            const NS::URL *URL) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_URL_), name, semantic, URL);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            const NS::String *string) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_string_), name, semantic,
      string);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            const TextureSampler *textureSampler) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_textureSampler_), name,
      semantic, textureSampler);
}
...
MDL::MaterialProperty::init(const NS::String *name, MaterialSemantic semantic,
                            CGColorRef color) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(initWithName_semantic_color_), name, semantic,
      color);
}

// static method: setProperties:
_MDL_INLINE void
MDL::MaterialProperty::setProperties(const MaterialProperty *property) {
  return Object::sendMessage<void>(_MDL_PRIVATE_CLS(MDLTexture),
                                   _MDL_PRIVATE_SEL(setProperties_), property);
}

// property: semantic
_MDL_INLINE MDL::MaterialSemantic MDL::MaterialProperty::semantic() const {
  return Object::sendMessage<MaterialSemantic>(this,
                                               _MDL_PRIVATE_SEL(semantic));
}
// write method: setSemantic:
_MDL_INLINE void MDL::MaterialProperty::setSemantic(MaterialSemantic semantic) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setSemantic_),
                                   semantic);
}

// property: type
_MDL_INLINE MDL::MaterialPropertyType MDL::MaterialProperty::type() const {
  return Object::sendMessage<MaterialPropertyType>(this,
                                                   _MDL_PRIVATE_SEL(type));
}
...
_MDL_INLINE void
MDL::MaterialProperty::setStringValue(const NS::String *stringValue) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setStringValue_),
                                   stringValue);
}
...
_MDL_INLINE void MDL::MaterialProperty::setURLValue(const NS::URL *URLValue) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setURLValue_),
                                   URLValue);
}

// property: textureSamplerValue
_MDL_INLINE MDL::TextureSampler *
MDL::MaterialProperty::textureSamplerValue() const {
  return Object::sendMessage<TextureSampler *>(
      this, _MDL_PRIVATE_SEL(textureSamplerValue));
}
// write method: setTextureSamplerValue:
_MDL_INLINE void MDL::MaterialProperty::setTextureSamplerValue(
    const TextureSampler *textureSamplerValue) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setTextureSamplerValue_), textureSamplerValue);
}
...
_MDL_INLINE void MDL::MaterialProperty::setFloatValue(float floatValue) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFloatValue_),
                                   floatValue);
}

// property: float2Value
_MDL_INLINE vector_float2 MDL::MaterialProperty::float2Value() const {
  return Object::sendMessage<vector_float2>(this,
                                            _MDL_PRIVATE_SEL(float2Value));
}
// write method: setFloat2Value:
_MDL_INLINE void
MDL::MaterialProperty::setFloat2Value(vector_float2 float2Value) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFloat2Value_),
                                   float2Value);
}

// property: float3Value
_MDL_INLINE vector_float3 MDL::MaterialProperty::float3Value() const {
  return Object::sendMessage<vector_float3>(this,
                                            _MDL_PRIVATE_SEL(float3Value));
}
// write method: setFloat3Value:
_MDL_INLINE void
MDL::MaterialProperty::setFloat3Value(vector_float3 float3Value) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFloat3Value_),
                                   float3Value);
}

// property: float4Value
_MDL_INLINE vector_float4 MDL::MaterialProperty::float4Value() const {
  return Object::sendMessage<vector_float4>(this,
                                            _MDL_PRIVATE_SEL(float4Value));
}
// write method: setFloat4Value:
_MDL_INLINE void
MDL::MaterialProperty::setFloat4Value(vector_float4 float4Value) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFloat4Value_),
                                   float4Value);
}

// property: matrix4x4
_MDL_INLINE matrix_float4x4 MDL::MaterialProperty::matrix4x4() const {
  return Object::sendMessage<matrix_float4x4>(this,
                                              _MDL_PRIVATE_SEL(matrix4x4));
}
// write method: setMatrix4x4:
_MDL_INLINE void
MDL::MaterialProperty::setMatrix4x4(matrix_float4x4 matrix4x4) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMatrix4x4_),
                                   matrix4x4);
}
...
_MDL_INLINE void MDL::MaterialProperty::setLuminance(float luminance) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setLuminance_),
                                   luminance);
}
...
// static method: alloc
_MDL_INLINE MDL::MaterialPropertyConnection *
MDL::MaterialPropertyConnection::alloc() {
  return NS::Object::alloc<MDL::MaterialPropertyConnection>(
      _MDL_PRIVATE_CLS(MDLMaterialPropertyConnection));
}

// method: initWithOutput:input:
_MDL_INLINE MDL::MaterialPropertyConnection *
MDL::MaterialPropertyConnection::init(const MaterialProperty *output,
                                      const MaterialProperty *input) {
  return Object::sendMessage<MaterialPropertyConnection *>(
      this, _MDL_PRIVATE_SEL(initWithOutput_input_), output, input);
}

// property: output
_MDL_INLINE MDL::MaterialProperty *
MDL::MaterialPropertyConnection::output() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(output));
}

// property: input
_MDL_INLINE MDL::MaterialProperty *
MDL::MaterialPropertyConnection::input() const {
...
_MDL_INLINE MDL::MaterialPropertyNode *MDL::MaterialPropertyNode::alloc() {
  return NS::Object::alloc<MDL::MaterialPropertyNode>(
      _MDL_PRIVATE_CLS(MDLMaterialPropertyNode));
}

// method: initWithInputs:outputs:evaluationFunction:
_MDL_INLINE MDL::MaterialPropertyNode *MDL::MaterialPropertyNode::init(
    const class MaterialProperty *inputs,
    // !!!: Uncertain
    const class MaterialProperty *outputs,
    void (^function)(const MaterialPropertyNode *)) {
  return Object::sendMessage<MaterialPropertyNode *>(
      this, _MDL_PRIVATE_SEL(initWithInputs_outputs_evaluationFunction_),
...
//    _MDL_PRIVATE_SEL(evaluationFunction));
//}
...
_MDL_INLINE MDL::MaterialPropertyGraph *MDL::MaterialPropertyGraph::alloc() {
  return NS::Object::alloc<MDL::MaterialPropertyGraph>(
      _MDL_PRIVATE_CLS(MDLMaterialPropertyGraph));
}

// method: initWithNodes:connections:
_MDL_INLINE MDL::MaterialPropertyGraph *
MDL::MaterialPropertyGraph::init(const NS::Array *nodes,
                                 const NS::Array *connections) {
  return Object::sendMessage<MaterialPropertyGraph *>(
      this, _MDL_PRIVATE_SEL(initWithNodes_connections_), nodes, connections);
}
...
_MDL_INLINE MDL::ScatteringFunction *MDL::ScatteringFunction::alloc() {
  return NS::Object::alloc<MDL::ScatteringFunction>(
      _MDL_PRIVATE_CLS(MDLScatteringFunction));
}
...
_MDL_INLINE MDL::MaterialProperty *MDL::ScatteringFunction::baseColor() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(baseColor));
}

// property: emission
_MDL_INLINE MDL::MaterialProperty *MDL::ScatteringFunction::emission() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(emission));
}

// property: specular
_MDL_INLINE MDL::MaterialProperty *MDL::ScatteringFunction::specular() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(specular));
}

// property: materialIndexOfRefraction
_MDL_INLINE MDL::MaterialProperty *
MDL::ScatteringFunction::materialIndexOfRefraction() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(materialIndexOfRefraction));
}

// property: interfaceIndexOfRefraction
_MDL_INLINE MDL::MaterialProperty *
MDL::ScatteringFunction::interfaceIndexOfRefraction() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(interfaceIndexOfRefraction));
}

// property: normal
_MDL_INLINE MDL::MaterialProperty *MDL::ScatteringFunction::normal() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(normal));
}

// property: ambientOcclusion
_MDL_INLINE MDL::MaterialProperty *
MDL::ScatteringFunction::ambientOcclusion() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(ambientOcclusion));
}

// property: ambientOcclusionScale
_MDL_INLINE MDL::MaterialProperty *
MDL::ScatteringFunction::ambientOcclusionScale() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(ambientOcclusionScale));
}

// MARK: Class PhysicallyPlausibleScatteringFunction

// static method: alloc
_MDL_INLINE MDL::PhysicallyPlausibleScatteringFunction *
MDL::PhysicallyPlausibleScatteringFunction::alloc() {
  return NS::Object::alloc<MDL::PhysicallyPlausibleScatteringFunction>(
      _MDL_PRIVATE_CLS(MDLPhysicallyPlausibleScatteringFunction));
}

// method: init
_MDL_INLINE MDL::PhysicallyPlausibleScatteringFunction *
MDL::PhysicallyPlausibleScatteringFunction::init() {
  return NS::Object::init<MDL::PhysicallyPlausibleScatteringFunction>();
}

// property: version
_MDL_INLINE NS::Integer
MDL::PhysicallyPlausibleScatteringFunction::version() const {
  return Object::sendMessage<NS::Integer>(this, _MDL_PRIVATE_SEL(version));
}

// property: subsurface
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::subsurface() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(subsurface));
}

// property: metallic
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::metallic() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(metallic));
}

// property: specularAmount
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::specularAmount() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(specularAmount));
}

// property: specularTint
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::specularTint() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(specularTint));
}

// property: roughness
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::roughness() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(roughness));
}

// property: anisotropic
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::anisotropic() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(anisotropic));
}

// property: anisotropicRotation
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::anisotropicRotation() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(anisotropicRotation));
}

// property: sheen
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::sheen() const {
  return Object::sendMessage<MaterialProperty *>(this, _MDL_PRIVATE_SEL(sheen));
}

// property: sheenTint
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::sheenTint() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(sheenTint));
}

// property: clearcoat
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::clearcoat() const {
  return Object::sendMessage<MaterialProperty *>(this,
                                                 _MDL_PRIVATE_SEL(clearcoat));
}

// property: clearcoatGloss
_MDL_INLINE MDL::MaterialProperty *
MDL::PhysicallyPlausibleScatteringFunction::clearcoatGloss() const {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(clearcoatGloss));
}
...
_MDL_INLINE MDL::Material *
MDL::Material::init(const NS::String *name,
                    const ScatteringFunction *scatteringFunction) {
  return Object::sendMessage<Material *>(
      this, _MDL_PRIVATE_SEL(initWithName_scatteringFunction_), name,
      scatteringFunction);
}

// method: setProperty:
_MDL_INLINE void MDL::Material::setProperty(const MaterialProperty *property) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setProperty_),
                                   property);
}

// method: removeProperty:
_MDL_INLINE void
MDL::Material::removeProperty(const MaterialProperty *property) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(removeProperty_),
                                   property);
}

// method: propertyNamed:
_MDL_INLINE MDL::MaterialProperty *
MDL::Material::propertyNamed(const NS::String *name) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(propertyNamed_), name);
}

// method: propertyWithSemantic:
_MDL_INLINE MDL::MaterialProperty *
MDL::Material::propertyWithSemantic(MaterialSemantic semantic) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(propertyWithSemantic_), semantic);
}

// method: propertiesWithSemantic:
_MDL_INLINE NS::Array *
MDL::Material::propertiesWithSemantic(MaterialSemantic semantic) {
  return Object::sendMessage<NS::Array *>(
      this, _MDL_PRIVATE_SEL(propertiesWithSemantic_), semantic);
}
...
_MDL_INLINE void MDL::Material::resolveTexturesWithResolver(
    const class AssetResolver *resolver) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(resolveTexturesWithResolver_), resolver);
}

// method: loadTexturesUsingResolver:
_MDL_INLINE void
MDL::Material::loadTexturesUsingResolver(const class AssetResolver *resolver) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(loadTexturesUsingResolver_), resolver);
}

// property: scatteringFunction
_MDL_INLINE MDL::ScatteringFunction *MDL::Material::scatteringFunction() const {
  return Object::sendMessage<ScatteringFunction *>(
      this, _MDL_PRIVATE_SEL(scatteringFunction));
}
...
_MDL_INLINE void MDL::Material::setBaseMaterial(const Material *baseMaterial) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setBaseMaterial_),
                                   baseMaterial);
}

// method: objectAtIndexedSubscript:
_MDL_INLINE MDL::MaterialProperty *
MDL::Material::objectAtIndexedSubscript(NS::UInteger idx) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(objectAtIndexedSubscript_), idx);
}

// method: objectForKeyedSubscript:
_MDL_INLINE MDL::MaterialProperty *
MDL::Material::objectForKeyedSubscript(const NS::String *name) {
  return Object::sendMessage<MaterialProperty *>(
      this, _MDL_PRIVATE_SEL(objectForKeyedSubscript_), name);
}
...
_MDL_INLINE MDL::MaterialFace MDL::Material::materialFace() const {
  return Object::sendMessage<MaterialFace>(this,
                                           _MDL_PRIVATE_SEL(materialFace));
}
// write method: setMaterialFace:
_MDL_INLINE void MDL::Material::setMaterialFace(MaterialFace materialFace) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMaterialFace_),
                                   materialFace);
}
...
//
// @discussion When files containing material properties are loaded and
// translated
...
//    A blend between a material behaving as a dielectric material at zero, and
//    a metal at one.
//
...
//    Power of the specular exponent in the case that a Blinn/Phong BSDF is in
//    use.
//
// MDLMaterialSemanticSpecularTint
//    At zero, the specular highlight will use the hue, saturation, and
//    intensity of incoming light to color the specular response; at one, the
//    material's base color, and the light's intensity will be used.
//
// MDLMaterialSemanticRoughness
//    Controls diffuse and specular response. A value of zero is smooth and
//    shiny. At one, a diffuse material will retroreflect, and the specular
//    highlight will be very spread out.
//
// MDLMaterialSemanticAnisotropic
//    The degree to which the specular highlight is elongated in the direction
//    of the local tangent basis. A mesh that does not have a tangent basis will
//    not respond to this parameter.
//
// MDLMaterialSemanticAnisotropicRotation
//    The degree to which the anisotropy is rotated relative to the direction of
//    the local tangent basis. Values from zero to one are mapped to zero to two
//    PI.
//
...
//    surrounding radiant environment and is typically used to attenuate it. It
//    is not intended to attenuate direct illumination sources.
//
...
//    Semantics defined at greater than this value are available to be user
//    defined. The first value is also used to indicate
//
// */
//
...
////    MDLMaterialPropertyTypeNone = 0, // default resulting from
///[MDLMaterialProperty init] /    MDLMaterialPropertyTypeString, /
/// MDLMaterialPropertyTypeURL, /    MDLMaterialPropertyTypeTexture, /
/// MDLMaterialPropertyTypeColor, /    MDLMaterialPropertyTypeFloat, /
/// MDLMaterialPropertyTypeFloat2, /    MDLMaterialPropertyTypeFloat3, /
/// MDLMaterialPropertyTypeFloat4, /    MDLMaterialPropertyTypeMatrix44, /
...
/// semantic:(MDLMaterialSemantic)semantic NS_DESIGNATED_INITIALIZER;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic float:(float)value;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic float2:(vector_float2)value;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic float3:(vector_float3)value;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic float4:(vector_float4)value;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic matrix4x4:(matrix_float4x4)value;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic URL:(nullable NSURL*)URL;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic string:(nullable NSString *)string;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic textureSampler:(nullable
/// MDLTextureSampler*)textureSampler;
////- (instancetype)initWithName:(NSString *)name
/// semantic:(MDLMaterialSemantic)semantic color:(CGColorRef)color;
////
...
////@property (nonatomic, retain, nullable) MDLTextureSampler
///*textureSamplerValue;
...
/// void(^evaluationFunction)(MDLMaterialPropertyNode*);
////
...
////@property (nonatomic, readonly) NSArray<MDLMaterialPropertyConnection*>
///*connections;
////
////@end
//
///**
// The base scattering function is Lambertian, with a Blinn-Phong specular
// response. Specular power for Blinn-Phong can be derived from the roughness
// property using an approximation.
// */
//
// API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0))
// MDL_EXPORT
...
//@property (nonatomic, readonly, retain) MDLMaterialProperty
...
// diffuse shape
//@property (nonatomic, readonly, retain) MDLMaterialProperty *metallic; // 0 =
// dielectric, 1 = metallic
...
//@property (nonatomic, readonly, retain) MDLMaterialProperty
//*anisotropicRotation;  // shape of specular highlight
//@property (nonatomic, readonly, retain) MDLMaterialProperty *sheen; // like
// velvet
...
//
//- (instancetype)initWithName:(NSString*)name
// scatteringFunction:(MDLScatteringFunction*)scatteringFunction;
//
...
//// Not recommended to use when there are multiple properties with same
/// semantic.
//- (nullable
// MDLMaterialProperty*)propertyWithSemantic:(MDLMaterialSemantic)semantic;
//
//// Returns the complete list of properties that match the semantic (e.g. Kd &
/// Kd_map)
//- (NSArray<MDLMaterialProperty *>
//*)propertiesWithSemantic:(MDLMaterialSemantic)semantic
// API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0));
//- (void)removeAllProperties;
//
//// Iterates all material properties. If they are string values, they are
/// resolved into / valid paths as NSURL values. / @param resolver If non-nil,
/// the resolver can be invoked to convert stringValues /                 to
/// NSURLs for loading.
//- (void)resolveTexturesWithResolver:(id<MDLAssetResolver>)resolver
// API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0));

// Iterates all material properties. If they are string values or NSURL values,
// and can be resolved as textures, then the string and NSURL values will be
// replaced by MDLTextureSampler values. The transforms on the samplers will be
// identity, the wrap modes will be clamp, and the filter modes will be linear.
// @param resolver If non-nil, the resolver can be invoked to convert
// stringValues
//                 to NSURLs for loading.
//- (void)loadTexturesUsingResolver:(id<MDLAssetResolver>)resolver
// API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0));
//
//@property (nonatomic, readonly, retain) MDLScatteringFunction
//*scatteringFunction;
//
///** @see MDLNamed */
//@property (nonatomic, copy) NSString *name;
