...
_MDL_INLINE void MDL::Object::setComponent(const MDL::Component *component,
                                           const Protocol *protocol) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setComponent_forProtocol_), component, protocol);
}

// method: componentConformingToProtocol:
_MDL_INLINE MDL::Component *
MDL::Object::componentConformingToProtocol(const Protocol *protocol) {
  return Object::sendMessage<MDL::Component *>(
      this, _MDL_PRIVATE_SEL(componentConformingToProtocol_), protocol);
}

// method: objectForKeyedSubscript:
_MDL_INLINE MDL::Component *
MDL::Object::objectForKeyedSubscript(const Protocol *key) {
  return Object::sendMessage<MDL::Component *>(
      this, _MDL_PRIVATE_SEL(objectForKeyedSubscript_), key);
}

// method: setObject:forKeyedSubscript:
_MDL_INLINE MDL::Component *MDL::Object::setObject(const MDL::Component *obj,
                                                   const Protocol *key) {
  return Object::sendMessage<MDL::Component *>(
      this, _MDL_PRIVATE_SEL(setObject_forKeyedSubscript_), obj, key);
}
...
// write method: setParent:
_MDL_INLINE void MDL::Object::setParent(const MDL::Object *parent) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setParent_), parent);
}
...
// write method: setInstance:
_MDL_INLINE void MDL::Object::setInstance(const MDL::Object *instance) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setInstance_),
                                   instance);
}
...
_MDL_INLINE void MDL::Object::enumerateChildObjectsOfClass(
    const Class objectClass, const MDL::Object *root,
    // !!!: Uncertain
...
_MDL_INLINE MDL::TransformComponent *MDL::Object::transform() const {
  return Object::sendMessage<MDL::TransformComponent *>(
      this, _MDL_PRIVATE_SEL(transform));
}
// write method: setTransform:
_MDL_INLINE void
MDL::Object::setTransform(const MDL::TransformComponent *transform) {
...
_MDL_INLINE MDL::ObjectContainerComponent *MDL::Object::children() const {
  return Object::sendMessage<MDL::ObjectContainerComponent *>(
      this, _MDL_PRIVATE_SEL(children));
}
// write method: setChildren:
_MDL_INLINE void
MDL::Object::setChildren(const MDL::ObjectContainerComponent *children) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setChildren_),
                                   children);
}
...
MDL::Object::boundingBoxAtTime(const NS::TimeInterval time) {
  return Object::sendMessage<MDL::AxisAlignedBoundingBox>(
...
_MDL_INLINE MDL::ObjectContainer *MDL::ObjectContainer::alloc() {
  return NS::Object::alloc<MDL::ObjectContainer>(
      _MDL_PRIVATE_CLS(MDLObjectContainer));
}
 ...
 */
//- (void)setComponent:(id<MDLComponent>)component forProtocol:(Protocol
//*)protocol;
//
///*!
// @method componentConformingToProtocol:
// @abstract Extensible component support that allows user of ModelIO to
// customize
//           MDLObjects to fit their format and workflow.
// */
//- (nullable id<MDLComponent>)componentConformingToProtocol:(Protocol
//*)protocol;
//
///*!
// @method objectForKeyedSubscript:
 ...
 */
//- (void)setObject:(nullable id<MDLComponent>)obj forKeyedSubscript:(Protocol
//*)key;
//
///*!
// @property parent
// @abstract Parent object. Nil if no parent.
// @discussion Set to nil when you remove this from an object container inside
// the
//             parent object.
// */
...
/*!
 ...
 @discussion nil, unless this object refers to original data to be instanced.
 The original data object can be any MDLObject that does not have a parent. If
 an MDLAsset has been created from a data file, any original objects parsed from
 that file will be found in the originals property. A typical use of a original
 and instance might be to have one original chair MDLObject, and instance six
 chairs around a table. The transform of each chair would be found on the parent
 MDLObject, but the various items making up the chair would be found in the
 original object.
 */
...
//             Requesting a path will force any unnamed objects to became
//             uniquely named. Any characters outside of [A-Z][a-z][0-9][:-_.]
//             will be forced to underscore.
// */
...
//                                root:(MDLObject*)root
//                          usingBlock:( void(^)(MDLObject* object, BOOL
//                          *stop))block
...
///*!
// @method addChild:
// @abstract Short hand for adding a child to the current container component
// and
//           setting the parent to this object.
// @discussion  It will create a default container if none exists. If children
// are
//              explicitly disallowed for an object, then add a container
//              component that throws on addition.
//
...
/*!
 ...
 @discussion Subclass the object container to support custom containers. Such
             custom containers might reference in memory representations,
 offline databases, and so on.
 */
// API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0))
// MDL_EXPORT
