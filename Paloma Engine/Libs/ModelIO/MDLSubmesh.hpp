...
public:
  ...
  // Read&Write
  const class MeshBuffer *edgeCreases() const;
  void setEdgeCreases(const class MeshBuffer *edgeCreases);

  // Read&Write
  NS::UInteger edgeCreaseIndicesCount() const;
  void setEdgeCreaseIndicesCount(NS::UInteger edgeCreaseIndicesCount);

  // Read&Write
  const class MeshBuffer *edgeCreaseIndices() const;
  void setEdgeCreaseIndices(const class MeshBuffer *edgeCreaseIndices);
};
...
public:
  ...
  class Submesh *init(const NS::String *name,
                      ...
                      NS::UInteger indexCount, IndexBitDepth indexType,
                      GeometryType geometryType, const Material *material);

  // initWithIndexBuffer:indexCount:indexType:geometryType:material:
  class Submesh *init(const NS::String *name, NS::UInteger indexCount,
                      IndexBitDepth indexType, GeometryType geometryType,
  ...
  class Submesh *init(const Submesh *submesh, IndexBitDepth indexType,
...
_MDL_INLINE MDL::SubmeshTopology *MDL::SubmeshTopology::alloc() {
  return NS::Object::alloc<MDL::SubmeshTopology>(
      _MDL_PRIVATE_CLS(MDLSubmeshTopology));
}

// method: initWithSubmesh:
_MDL_INLINE MDL::SubmeshTopology *
MDL::SubmeshTopology::init(const Submesh *submesh) {
  return Object::sendMessage<SubmeshTopology *>(
      this, _MDL_PRIVATE_SEL(initWithSubmesh_), submesh);
}

// property: faceTopology
_MDL_INLINE MDL::MeshBuffer *MDL::SubmeshTopology::faceTopology() const {
  return Object::sendMessage<MeshBuffer *>(this,
                                           _MDL_PRIVATE_SEL(faceTopology));
}
// write method: setFaceTopology:
_MDL_INLINE void
MDL::SubmeshTopology::setFaceTopology(const class MeshBuffer *faceTopology) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFaceTopology_),
                                   faceTopology);
}
...
_MDL_INLINE void MDL::SubmeshTopology::setFaceCount(NS::UInteger faceCount) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setFaceCount_),
                                   faceCount);
}

// property: vertexCreaseIndices
_MDL_INLINE MDL::MeshBuffer *MDL::SubmeshTopology::vertexCreaseIndices() const {
  return Object::sendMessage<MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(vertexCreaseIndices));
}
// write method: setVertexCreaseIndices:
_MDL_INLINE void MDL::SubmeshTopology::setVertexCreaseIndices(
    const class MeshBuffer *vertexCreaseIndices) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setVertexCreaseIndices_), vertexCreaseIndices);
}

// property: vertexCreases
_MDL_INLINE MDL::MeshBuffer *MDL::SubmeshTopology::vertexCreases() const {
  return Object::sendMessage<MeshBuffer *>(this,
                                           _MDL_PRIVATE_SEL(vertexCreases));
}
// write method: setVertexCreases:
_MDL_INLINE void
MDL::SubmeshTopology::setVertexCreases(const class MeshBuffer *vertexCreases) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setVertexCreases_),
                                   vertexCreases);
}
...
_MDL_INLINE NS::UInteger MDL::SubmeshTopology::vertexCreaseCount() const {
  return Object::sendMessage<NS::UInteger>(this,
                                           _MDL_PRIVATE_SEL(vertexCreaseCount));
}
// write method: setVertexCreaseCount:
_MDL_INLINE void
MDL::SubmeshTopology::setVertexCreaseCount(NS::UInteger vertexCreaseCount) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setVertexCreaseCount_), vertexCreaseCount);
}
...
_MDL_INLINE void MDL::SubmeshTopology::setHoleCount(NS::UInteger holeCount) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setHoleCount_),
                                   holeCount);
}

// property: edgeCreases
_MDL_INLINE const MDL::MeshBuffer *MDL::SubmeshTopology::edgeCreases() const {
  return Object::sendMessage<const MeshBuffer *>(this,
                                                 _MDL_PRIVATE_SEL(edgeCreases));
}
// write method: setEdgeCreases:
_MDL_INLINE void
MDL::SubmeshTopology::setEdgeCreases(const MeshBuffer *edgeCreases) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setEdgeCreases_),
                                   edgeCreases);
}

// property: edgeCreaseIndicesCount
_MDL_INLINE NS::UInteger MDL::SubmeshTopology::edgeCreaseIndicesCount() const {
  return Object::sendMessage<NS::UInteger>(
      this, _MDL_PRIVATE_SEL(edgeCreaseIndicesCount));
}
// write method: setEdgeCreaseIndicesCount:
_MDL_INLINE void MDL::SubmeshTopology::setEdgeCreaseIndicesCount(
    const NS::UInteger edgeCreaseIndicesCount) {
  return Object::sendMessage<void>(this,
                                   _MDL_PRIVATE_SEL(setEdgeCreaseIndicesCount_),
                                   edgeCreaseIndicesCount);
}

// property: edgeCreaseIndices
_MDL_INLINE const MDL::MeshBuffer *
MDL::SubmeshTopology::edgeCreaseIndices() const {
  return Object::sendMessage<const MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(edgeCreaseIndices));
}
// write method: setEdgeCreaseIndices:
_MDL_INLINE void MDL::SubmeshTopology::setEdgeCreaseIndices(
    const MeshBuffer *edgeCreaseIndices) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setEdgeCreaseIndices_), edgeCreaseIndices);
}
...
_MDL_INLINE MDL::Submesh *
MDL::Submesh::init(const NS::String *name, const class MeshBuffer *indexBuffer,
                   NS::UInteger indexCount, IndexBitDepth indexType,
                   GeometryType geometryType, const Material *material) {
  return Object::sendMessage<Submesh *>(
      this,
      _MDL_PRIVATE_SEL(
...
_MDL_INLINE MDL::Submesh *MDL::Submesh::init(const Submesh *submesh,
                                             ...
                                             GeometryType geometryType) {
  return Object::sendMessage<Submesh *>(
      this, _MDL_PRIVATE_SEL(initWithMDLSubmesh_indexType_geometryType_),
...
_MDL_INLINE MDL::MeshBuffer *
MDL::Submesh::indexBufferAsIndexType(IndexBitDepth indexType) {
  return Object::sendMessage<MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(indexBufferAsIndexType_), indexType);
}
...
_MDL_INLINE MDL::GeometryType MDL::Submesh::geometryType() const {
  return Object::sendMessage<GeometryType>(this,
                                           _MDL_PRIVATE_SEL(geometryType));
}
...
_MDL_INLINE void MDL::Submesh::setMaterial(const Material *material) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setMaterial_),
                                   material);
}

// property: topology
_MDL_INLINE MDL::SubmeshTopology *MDL::Submesh::topology() const {
  return Object::sendMessage<MDL::SubmeshTopology *>(
      this, _MDL_PRIVATE_SEL(topology));
}
// write method: setTopology:
_MDL_INLINE void MDL::Submesh::setTopology(const SubmeshTopology *topology) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setTopology_),
                                   topology);
}
...
///*!
// @method initWithSubmesh:
// @abstract create a topology object corresponding to the topology in the
// submesh
// */
...
// @abstract A buffer of 8 bit unsigned integer values, where each entry
// corresponds to the number of vertices making up a face.
//
...
//
///*! A crease value at a vertex to be applied during subdivision. Vertex
/// creases
...
// @abstract Initialize submesh with all data necessary to make properties valid
//
// @discussion The geometry type will typically be
...
///*!
// @property topology
// @abstract Topology data structure for use with
// MDLGeometryTypeVariableTopology
//
// @discussion ignored for geometry types other than
// MDLGeometryTypeVariableTopology.
//             A submesh of type MDLGeometryTypeVariableTopology with no
//             topology data is an empty submesh.
//*/
