...
_MDL_ENUM(NS::UInteger, LightType){
    LightTypeUnknown = 0, LightTypeAmbient,         LightTypeDirectional,
    LightTypeSpot,        LightTypePoint,           LightTypeLinear,
    LightTypeDiscArea,    LightTypeRectangularArea, LightTypeSuperElliptical,
    LightTypePhotometric, LightTypeProbe,           LightTypeEnvironment};
...
public:
  ...
  void
  generateSphericalHarmonicsFromLight(NS::UInteger sphericalHarmonicsLevel);
...
public:
  ...
  static class LightProbe *lightProbeWithTextureSize(
      NS::Integer textureSize, const Transform *transform,
      const NS::Array *lightsToConsider, const NS::Array *objectsToConsider,
      const Texture *reflectiveCubemap, const Texture *irradianceCubemap);
};
...
_MDL_INLINE CGColorRef MDL::Light::irradianceAtPoint(vector_float3 point) {
  return Object::sendMessage<CGColorRef>(
      this, _MDL_PRIVATE_SEL(irradianceAtPoint_), point);
}

// method: irradianceAtPoint:colorSpace:
_MDL_INLINE CGColorRef
MDL::Light::irradianceAtPoint(vector_float3 point, CGColorSpaceRef colorSpace) {
  return Object::sendMessage<CGColorRef>(
      this, _MDL_PRIVATE_SEL(irradianceAtPoint_colorSpace_), point, colorSpace);
}
...
_MDL_INLINE void MDL::Light::setLightType(LightType lightType) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setLightType_),
                                   lightType);
}
...
_MDL_INLINE void MDL::Light::setColorSpace(const NS::String *colorSpace) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setColorSpace_),
                                   colorSpace);
}
...
// static method: alloc
_MDL_INLINE MDL::PhysicallyPlausibleLight *
MDL::PhysicallyPlausibleLight::alloc() {
  return NS::Object::alloc<MDL::PhysicallyPlausibleLight>(
      _MDL_PRIVATE_CLS(MDLPhysicallyPlausibleLight));
}

// method: init
_MDL_INLINE MDL::PhysicallyPlausibleLight *
MDL::PhysicallyPlausibleLight::init() {
  return NS::Object::init<MDL::PhysicallyPlausibleLight>();
}

// method: setColorByTemperature:
_MDL_INLINE void
MDL::PhysicallyPlausibleLight::setColorByTemperature(float temperature) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setColorByTemperature_), temperature);
}
...
_MDL_INLINE void
MDL::PhysicallyPlausibleLight::setInnerConeAngle(float innerConeAngle) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setInnerConeAngle_),
                                   innerConeAngle);
}
...
_MDL_INLINE void
MDL::PhysicallyPlausibleLight::setOuterConeAngle(float outerConeAngle) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setOuterConeAngle_),
                                   outerConeAngle);
}

// property: attenuationStartDistance
_MDL_INLINE float
MDL::PhysicallyPlausibleLight::attenuationStartDistance() const {
  return Object::sendMessage<float>(this,
                                    _MDL_PRIVATE_SEL(attenuationStartDistance));
}
// write method: setAttenuationStartDistance:
_MDL_INLINE void MDL::PhysicallyPlausibleLight::setAttenuationStartDistance(
    float attenuationStartDistance) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setAttenuationStartDistance_),
...
_MDL_INLINE void MDL::AreaLight::setAreaRadius(float areaRadius) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(setAreaRadius_),
                                   areaRadius);
}
...
_MDL_INLINE vector_float2 MDL::AreaLight::superEllipticPower() const {
  return Object::sendMessage<vector_float2>(
      this, _MDL_PRIVATE_SEL(superEllipticPower));
}
// write method: setSuperEllipticPower:
_MDL_INLINE void
MDL::AreaLight::setSuperEllipticPower(vector_float2 superEllipticPower) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(setSuperEllipticPower_), superEllipticPower);
}
...
_MDL_INLINE MDL::PhotometricLight *MDL::PhotometricLight::alloc() {
  return NS::Object::alloc<MDL::PhotometricLight>(
      _MDL_PRIVATE_CLS(MDLPhotometricLight));
}

// method: initWithIESProfile:
_MDL_INLINE MDL::PhotometricLight *
MDL::PhotometricLight::init(const NS::URL *URL) {
  return Object::sendMessage<PhotometricLight *>(
      this, _MDL_PRIVATE_SEL(initWithIESProfile_), URL);
}

// method: generateSphericalHarmonicsFromLight:
_MDL_INLINE void MDL::PhotometricLight::generateSphericalHarmonicsFromLight(
    NS::UInteger sphericalHarmonicsLevel) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(generateSphericalHarmonicsFromLight_),
      sphericalHarmonicsLevel);
}

// method: generateCubemapFromLight:
_MDL_INLINE void
MDL::PhotometricLight::generateCubemapFromLight(NS::UInteger textureSize) {
  return Object::sendMessage<void>(
      this, _MDL_PRIVATE_SEL(generateCubemapFromLight_), textureSize);
}

// method: generateTexture:
_MDL_INLINE MDL::Texture *
MDL::PhotometricLight::generateTexture(NS::UInteger textureSize) {
  return Object::sendMessage<Texture *>(
      this, _MDL_PRIVATE_SEL(generateTexture_), textureSize);
}
...
MDL::PhotometricLight::sphericalHarmonicsLevel() const {
...
_MDL_INLINE NS::Data *
MDL::PhotometricLight::sphericalHarmonicsCoefficients() const {
  return Object::sendMessage<NS::Data *>(
      this, _MDL_PRIVATE_SEL(sphericalHarmonicsCoefficients));
}
...
_MDL_INLINE MDL::LightProbe *
MDL::LightProbe::init(const Texture *reflectiveTexture,
                      const Texture *irradianceTexture) {
  return Object::sendMessage<LightProbe *>(
      this, _MDL_PRIVATE_SEL(initWithReflectiveTexture_irradianceTexture_),
      reflectiveTexture, irradianceTexture);
}
...
// method:
// lightProbeWithTextureSize:forLocation:lightsToConsider:objectsToConsider:reflectiveCubemap:irradianceCubemap:
_MDL_INLINE MDL::LightProbe *MDL::LightProbe::lightProbeWithTextureSize(
    NS::Integer textureSize, const Transform *transform,
    const NS::Array *lightsToConsider, const NS::Array *objectsToConsider,
    const Texture *reflectiveCubemap, const Texture *irradianceCubemap) {
  return Object::sendMessage<LightProbe *>(
      ...
      textureSize, transform, lightsToConsider, objectsToConsider,
...
//
///** A utility function that returns the irradiance from the light at a given
/// point.
...
/*!
 ...
 @property innerConeAngle Within this cone, light is at maximum brightness.
 Units are degrees.
...
//
//// 90 means down the light axis to perpendicular is spanned (lightType will be
/// MDLLightSpot) / 180 means down the light axis to up the light axis is
/// spanned (lightType will be MDLLightPoint) / default is 22.5 degrees
...
/*!
 ...
 @property sphericalHarmonicsLevel The value
 generateSphericalHarmonicsFromLight: used to calculate the spherical harmonics
 coefficients
...
//
//// Init with an IES profile file, generate a light web of specified width and
/// height
...
// 180 2D when the previous statement fails and innerConeAngle < 89 3D in all
// other cases the parameter textureSize is the size in pixels of the texture
// image. For a size of N, 1D generates an Nx1 image, 2D generates an NxN image,
// 3D generates an Nx(N*6) image (i.e. cubemap).
// */
...
//
//@property (nonatomic, copy, nullable, readonly) NSData
...
//                                          forLocation:(MDLTransform
//                                          *)transform
//                                     lightsToConsider:(NSArray<MDLLight*>*)lightsToConsider
//                                    objectsToConsider:(NSArray<MDLObject*>*)objectsToConsider
//                                    reflectiveCubemap:(nullable
//                                    MDLTexture*)reflectiveCubemap
//                                    irradianceCubemap:(nullable
//                                    MDLTexture*)irradianceCubemap;
//
//@end
//
//
