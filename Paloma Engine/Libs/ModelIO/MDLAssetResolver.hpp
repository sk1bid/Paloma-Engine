...
_MDL_INLINE BOOL
MDL::AssetResolver::canResolveAssetNamed(const NS::String *name) {
  return Object::sendMessage<BOOL>(
      this, _MDL_PRIVATE_SEL(canResolveAssetNamed_), name);
}

// method: resolveAssetNamed:
_MDL_INLINE NS::URL *
MDL::AssetResolver::resolveAssetNamed(const NS::String *name) {
  return Object::sendMessage<NS::URL *>(
      this, _MDL_PRIVATE_SEL(resolveAssetNamed_), name);
}
...
_MDL_INLINE MDL::RelativeAssetResolver *MDL::RelativeAssetResolver::alloc() {
  return NS::Object::alloc<MDL::RelativeAssetResolver>(
      _MDL_PRIVATE_CLS(MDLRelativeAssetResolver));
}

// method: initWithAsset:
_MDL_INLINE MDL::RelativeAssetResolver *
MDL::RelativeAssetResolver::init(const MDL::Asset *asset) {
  return Object::sendMessage<MDL::RelativeAssetResolver *>(
      this, _MDL_PRIVATE_SEL(initWithAsset_), asset);
}
...
_MDL_INLINE MDL::PathAssetResolver *MDL::PathAssetResolver::alloc() {
  return NS::Object::alloc<MDL::PathAssetResolver>(
      _MDL_PRIVATE_CLS(MDLPathAssetResolver));
}

// method: initWithPath:
_MDL_INLINE MDL::PathAssetResolver *
MDL::PathAssetResolver::init(const NS::String *path) {
  return Object::sendMessage<MDL::PathAssetResolver *>(
      this, _MDL_PRIVATE_SEL(initWithPath_), path);
}
...
_MDL_INLINE MDL::BundleAssetResolver *MDL::BundleAssetResolver::alloc() {
  return NS::Object::alloc<MDL::BundleAssetResolver>(
      _MDL_PRIVATE_CLS(MDLBundleAssetResolver));
}

// method: initWithBundle:
_MDL_INLINE MDL::BundleAssetResolver *
MDL::BundleAssetResolver::init(const NS::String *path) {
  return Object::sendMessage<MDL::BundleAssetResolver *>(
      this, _MDL_PRIVATE_SEL(initWithBundle_), path);
}
