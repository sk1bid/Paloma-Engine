...
// Protocol
class MeshBuffer
    : public NS::Copying<MeshBuffer> /*, NS::Referencing<MeshBuffer>*/
{
public:
  // fillData:offset:
...
public:
  ...
  // initWithType:length
  MDL::MeshBufferData *init(const MDL::MeshBufferType type,
                            NS::UInteger length);
...
public:
  ...
  class MeshBufferZone *newZoneForBuffersWithSize(const NS::Array *sizes,
                                                  const NS::Array *types);

  // newBuffer:type:
  class MeshBuffer *newBuffer(NS::UInteger length, MDL::MeshBufferType type);

  // newBufferWithData:type:
  class MeshBuffer *newBufferWithData(const NS::Data *data,
                                      MDL::MeshBufferType type);

  // newBufferFromZone:length:type:
  class MeshBuffer *newBufferFromZone(const MDL::MeshBufferZone *zone,
                                      NS::UInteger length,
                                      MDL::MeshBufferType type);
...
_MDL_INLINE MDL::MeshBufferMap *MDL::MeshBufferMap::alloc() {
  return NS::Object::alloc<MDL::MeshBufferMap>(
      _MDL_PRIVATE_CLS(MDLMeshBufferMap));
}

// method: initWithBytes:deallocator:
_MDL_INLINE MDL::MeshBufferMap *
MDL::MeshBufferMap::init(const void *bytes, const void (^deallocator)(void)) {
  return Object::sendMessage<MDL::MeshBufferMap *>(
      this, _MDL_PRIVATE_SEL(initWithBytes_deallocator_), bytes, deallocator);
}
...
_MDL_INLINE void MDL::MeshBuffer::fillData(const NS::Data *data,
                                           NS::UInteger offset) {
  return Object::sendMessage<void>(this, _MDL_PRIVATE_SEL(fillData_offset_),
                                   data, offset);
}
...
_MDL_INLINE MDL::MeshBufferAllocator *MDL::MeshBuffer::allocator() const {
  return Object::sendMessage<MDL::MeshBufferAllocator *>(
      this, _MDL_PRIVATE_SEL(allocator));
}

// property: zone
_MDL_INLINE MDL::MeshBufferZone *MDL::MeshBuffer::zone() const {
  return Object::sendMessage<MDL::MeshBufferZone *>(this,
                                                    _MDL_PRIVATE_SEL(zone));
}
...
_MDL_INLINE MDL::MeshBufferData *MDL::MeshBufferData::alloc() {
  return NS::Object::alloc<MDL::MeshBufferData>(
      _MDL_PRIVATE_CLS(MDLMeshBufferData));
}

// method: initWithType:length
_MDL_INLINE MDL::MeshBufferData *
MDL::MeshBufferData::init(const MDL::MeshBufferType type, NS::UInteger length) {
  return Object::sendMessage<MDL::MeshBufferData *>(
      this, _MDL_PRIVATE_SEL(initWithType_length_), type, length);
}
...
MDL::MeshBufferData::init(const MDL::MeshBufferType type,
                          const NS::Data *data) {
  return Object::sendMessage<MDL::MeshBufferData *>(
      this, _MDL_PRIVATE_SEL(initWithType_data_), type, data);
}
...
// method: newZone:
_MDL_INLINE MDL::MeshBufferZone *
MDL::MeshBufferAllocator::newZone(NS::UInteger capacity) {
  return Object::sendMessage<MDL::MeshBufferZone *>(
      this, _MDL_PRIVATE_SEL(newZone_), capacity);
}

// method: newZoneForBuffersWithSize:andType:
_MDL_INLINE MDL::MeshBufferZone *
MDL::MeshBufferAllocator::newZoneForBuffersWithSize(const NS::Array *sizes,
                                                    const NS::Array *types) {
  return Object::sendMessage<MDL::MeshBufferZone *>(
      this, _MDL_PRIVATE_SEL(newZoneForBuffersWithSize_andType_), sizes, types);
}

// method: newBuffer:type:
_MDL_INLINE MDL::MeshBuffer *
MDL::MeshBufferAllocator::newBuffer(NS::UInteger length,
                                    MDL::MeshBufferType type) {
  return Object::sendMessage<MDL::MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(newBuffer_type_), length, type);
}

// method: newBufferWithData:type:
_MDL_INLINE MDL::MeshBuffer *
MDL::MeshBufferAllocator::newBufferWithData(const NS::Data *data,
                                            MDL::MeshBufferType type) {
  return Object::sendMessage<MDL::MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(newBufferWithData_type_), data, type);
}

// method: newBufferFromZone:length:type:
_MDL_INLINE MDL::MeshBuffer *
MDL::MeshBufferAllocator::newBufferFromZone(const MDL::MeshBufferZone *zone,
                                            NS::UInteger length,
                                            MDL::MeshBufferType type) {
  return Object::sendMessage<MDL::MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(newBufferFromZone_length_type_), zone, length,
      type);
}
...
MDL::MeshBufferAllocator::newBufferFromZone(const MDL::MeshBufferZone *zone,
                                            ...
                                            MDL::MeshBufferType type) {
  return Object::sendMessage<MDL::MeshBuffer *>(
      this, _MDL_PRIVATE_SEL(newBufferFromZone_length_type_), zone, data, type);
}

// MARK: MeshBufferDataAllocator

// static method: alloc
_MDL_INLINE MDL::MeshBufferDataAllocator *
MDL::MeshBufferDataAllocator::alloc() {
  return NS::Object::alloc<MDL::MeshBufferDataAllocator>(
      _MDL_PRIVATE_CLS(MDLMeshBufferDataAllocator));
}
...
_MDL_INLINE MDL::MeshBufferZoneDefault *MDL::MeshBufferZoneDefault::alloc() {
  return NS::Object::alloc<MDL::MeshBufferZoneDefault>(
      _MDL_PRIVATE_CLS(MDLMeshBufferZoneDefault));
}
...
// property: allocator
_MDL_INLINE MDL::MeshBufferAllocator *
MDL::MeshBufferZoneDefault::allocator() const {
...
/*!
 ...
 @discussion The buffer will remain mapped as long as the returned
 MDLMeshBufferMap object exists. Mapping a buffer may impose restrictions on a
 system. For instance,  if the implementing class maps an OpenGL buffer, that
 ...
 */
//- (instancetype)initWithType:(MDLMeshBufferType)type
 ...
 */
//- (instancetype)initWithType:(MDLMeshBufferType)type data:(nullable
// NSData*)data;
 ...
 */
//-(nullable id<MDLMeshBuffer>)newBufferFromZone:(nullable
